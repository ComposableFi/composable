...
exports.Pica = exports.mintAssetsToWallet = void 0;
 ...
 */
async function mintAssetsToWallet(api, wallet, sudoKey, assetIDs, amount = Pica(900000000)) {
    const tx = [];
    ...
    const { data: [result] } = await (0, polkadotjs_1.sendWithBatchAndWaitForSuccess)(api, sudoKey, api.events.sudo.Sudid.is, tx, false);
    ...
    for (let i = 0; i < assetIDs.length; i++) {
        ...
        (0, chai_1.expect)(parseInt(newBalance.toString())).to.be.greaterThan(balancesBefore[i]);
    }
}
exports.mintAssetsToWallet = mintAssetsToWallet;
/***
...
exports.Pica = Pica;
//# sourceMappingURL=mintingHelper.js.map