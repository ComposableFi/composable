...
import { ComposableTraitsDefiCurrencyPairCurrencyId, ComposableTraitsDexFee } from "@composable/types/interfaces";
...
export default async function(
  ...
  pair:
    ...
    { base: u128 | BN | bigint | number, quote: u128 | BN | bigint | number },
  quoteAmount: number | u128 | Balance | BN | bigint,
  ...
  return await sendAndWaitForSuccess(
    ...
    api.tx.pablo.swap(poolId, pair, quoteAmount, minReceive, keepAlive)
  );
}
