...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    stakingRewards: {
      ...
      RewardAccumulationError: AugmentedEvent<ApiType, [poolId: u16, assetId: u128], { poolId: u16, assetId: u128 }>;
      /**
