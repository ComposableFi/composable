...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    stakingRewards: {
      MaxRewardsAccumulated: AugmentedEvent<ApiType, [poolId: u16, assetId: u128], { poolId: u16, assetId: u128 }>;
      RewardAccumulationHookError: AugmentedEvent<ApiType, [poolId: u16, assetId: u128, error: PalletStakingRewardsRewardAccumulationHookError], { poolId: u16, assetId: u128, error: PalletStakingRewardsRewardAccumulationHookError }>;
      /**
      ...
      RewardsPotIncreased: AugmentedEvent<ApiType, [poolId: u16, assetId: u128, amount: u128], { poolId: u16, assetId: u128, amount: u128 }>;
      /**
       * Reward transfer event.
       **/
      RewardTransferred: AugmentedEvent<ApiType, [from: AccountId32, pool: u16, rewardCurrency: u128, rewardIncrement: u128], { from: AccountId32, pool: u16, rewardCurrency: u128, rewardIncrement: u128 }>;
      /**
       * Split stake position into two positions
       **/
      SplitPosition: AugmentedEvent<ApiType, [positions: Vec<u128>], { positions: Vec<u128> }>;
      StakeAmountExtended: AugmentedEvent<ApiType, [positionId: u128, amount: u128], { positionId: u128, amount: u128 }>;
      Staked: AugmentedEvent<ApiType, [poolId: u16, owner: AccountId32, amount: u128, durationPreset: u64, positionId: u128, keepAlive: bool], { poolId: u16, owner: AccountId32, amount: u128, durationPreset: u64, positionId: u128, keepAlive: bool }>;
