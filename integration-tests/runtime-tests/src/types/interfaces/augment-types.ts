...
import type { ComposableTraitsBondedFinanceBondDuration, ComposableTraitsBondedFinanceBondOffer, ComposableTraitsBondedFinanceBondOfferReward } from '@composable/types/interfaces/bondedFinance';
