...
describe("tx.constantProductDex Tests", function () {
  ...
  describe("ConstantProductDex Add Liquidity Tests", async function () {
    ...
    it("Given that users has sufficient balance, User1 can send funds to pool", async function () {
      const result = await addFundsToPool(api, poolId, walletId1, baseAmount, quoteAmount);
    ...
    it("Given that users has sufficient balance, users can send funds to pool2", async function () {
      const result = await addFundsToPool(api, poolId2, walletId2, baseAmount, quoteAmount);
    ...
    it(
      ...
      async function () {
        ...
        const result = await addFundsToPool(api, poolId, walletId2, assetAmount, quoteAmount);
    ...
    it(
      ...
      async function () {
        ...
        await addFundsToPool(api, poolId2, walletId1, baseAmount, quoteAmount).catch(error =>
    ...
    it(
      ...
      async function () {
        ...
        const result = await addFundsToPool(api, poolId2, walletId1, baseAmount, quoteAmount);
