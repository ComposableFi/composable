...
describe("tx.bondedFinance Tests", function () {
    ...
    before("mint assets into the wallet", async function () {
        ...
        await (0, mintingHelper_1.mintAssetsToWallet)(api, walletAlice, walletAlice, [4]);
        await (0, mintingHelper_1.mintAssetsToWallet)(api, walletBob, walletAlice, [4]);
    });
    ...
    describe("tx.bondedFinance.offer & .bond Success Tests", function () {
        ...
        it("[SHORT] Can create a new offer", async function () {
            ...
            const { data: [result] } = await (0, offerTests_1.txBondedFinanceOfferSuccessTest)(api, walletAlice, requestParameters);
        ...
        it("Can create a second new offer", async function () {
            ...
            const { data: [result] } = await (0, offerTests_1.txBondedFinanceOfferSuccessTest)(api, walletBob, requestParameters);
            (0, chai_1.expect)(result.toNumber()).to.be.a("number");
        ...
        it("[SHORT] Can bond to newly created offer", async function () {
            ...
            const { data: [result] } = await (0, bondTests_1.txBondedFinanceBondSuccessTest)(api, walletBob, offerId, nbOfBonds);
            (0, chai_1.expect)(result.toNumber()).to.be.equal(bondOfferId1);
        });
    });
    /**
    ...
    describe("tx.bondedFinance.offer Failure Tests", function () {
        ...
        it("Should not be able to create offer (bondPrice < MIN_VESTED_TRANSFER)", async function () {
            ...
            await (0, offerTests_1.txBondedFinanceOfferFailureTest)(api, walletAlice, requestParameters).catch(e => (0, chai_1.expect)(e).to.be.an("Error"));
        });
    ...
    describe("tx.bondedFinance.cancel Failure Tests", function () {
        ...
        it("Should not be able to cancel offer that doesn't exist", async function () {
            if (!test_configuration_json_1.default.enabledTests.cancel_failure.cancel_offer_not_exist)
                this.skip();
            const offerId = 1337;
            await (0, cancelTests_1.txBondedFinanceCancelFailureTest)(api, walletAlice, offerId).catch(e => (0, chai_1.expect)(e).to.be.an("Error"));
        });
    });
    /**
    ...
    describe("tx.bondedFinance.cancel Success Tests", function () {
        ...
        it("Can cancel offer created in first bondedFinance.offer test by creator", async function () {
            if (!test_configuration_json_1.default.enabledTests.cancel_success.cancel_by_creator)
                this.skip();
            const { data: [result] } = await (0, cancelTests_1.txBondedFinanceCancelSuccessTest)(api, walletAlice, bondOfferId1);
            (0, chai_1.expect)(result.toNumber()).to.be.a("number");
            (0, chai_1.expect)(result.toNumber()).to.be.equal(bondOfferId1);
        });
        ...
        it("Can sudo (diff. account) cancel offer created in second bondedFinance.offer", async function () {
            if (!test_configuration_json_1.default.enabledTests.cancel_success.cancel_by_sudo)
                this.skip();
            const { data: [result] } = await (0, cancelTests_1.txBondedFinanceCancelSudoSuccessTest)(api, walletAlice, bondOfferId2);
            (0, chai_1.expect)(result.isOk).to.be.true;
        });
    });
});
//# sourceMappingURL=txBondedFinanceTests.js.map