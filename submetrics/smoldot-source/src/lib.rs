...
pub async fn composable_polkadot(
    ...
    let smoldot_light::AddChainSuccess {
        ...
        .add_chain(smoldot_light::AddChainConfig {
            specification: include_str!(
                "/home/dz/github.com/smol-dot/smoldot/demo-chain-specs/polkadot.json"
            ),
    ...
    let smoldot_light::AddChainSuccess {
        ...
        .add_chain(smoldot_light::AddChainConfig {
            specification: include_str!("../../../code/parachain/node/src/res/composable.json"),
            json_rpc: smoldot_light::AddChainConfigJsonRpc::Enabled {
                max_pending_requests: NonZeroU32::new(128).unwrap(),
                max_subscriptions: 1024,
            },
...
chain_id,
    ...
    log::warn!("relay_chain_id {:?}", relay_chain_id);
    log::warn!("chain_id {:?}", chain_id);
    loop {
...
pub async fn picasso_kusama(sink: futures_channel::mpsc::UnboundedSender<String>) {
    let mut client = smoldot_light::Client::new(
        smoldot_light::platform::async_std::AsyncStdTcpWebSocket::new(
            env!("CARGO_PKG_NAME").into(),
            env!("CARGO_PKG_VERSION").into(),
    ...
    let smoldot_light::AddChainSuccess {
        chain_id: relay_chain_id,
        json_rpc_responses: json_rpc_responses,
    } = client
        .add_chain(smoldot_light::AddChainConfig {
            specification: include_str!(
                "/home/dz/github.com/smol-dot/smoldot/demo-chain-specs/kusama.json"
            ),
            json_rpc: smoldot_light::AddChainConfigJsonRpc::Enabled {
                max_pending_requests: NonZeroU32::new(128).unwrap(),
                max_subscriptions: 1024,
    ...
    let smoldot_light::AddChainSuccess {
        ...
        .add_chain(smoldot_light::AddChainConfig {
            specification: include_str!("../../../code/parachain/node/src/res/picasso.json"),
            json_rpc: smoldot_light::AddChainConfigJsonRpc::Enabled {
                max_pending_requests: NonZeroU32::new(128).unwrap(),
                max_subscriptions: 1024,
            },
    ...
    let subscribes = r#"{"id":1,"jsonrpc":"2.0","method":"state_subscribeStorage","params": { "list": ["0x26aa394eea5630e07c48ae0c9558cef780d41e5e16056765bc8461851072c9d7", "0x99971b5749ac43e0235e41b0d37869188ee7418a6531173d60d1f6a82d8f4d51", "0x26aa394eea5630e07c48ae0c9558cef7b99d880ec681799c0cf30e8886371da9", "0x26aa394eea5630e07c48ae0c9558cef7b99d880ec681799c0cf30e8886371da9004325711314fc9a69f6de0d037dd9126e61132120b0eb4a95015ecb49a30a7893b34709c590f2414148f5c8e4460516", "0x26aa394eea5630e07c48ae0c9558cef7b99d880ec681799c0cf30e8886371da95a3fb8de4321e12fad081eaeece61bc56d6f646c506f745374616b650000000000000000000000000000000000000000"] }}"#;
    client.json_rpc_request(subscribes, relay_chain_id).unwrap();
