...
impl<T: frame_system::Config> utility::WeightInfo for WeightInfo<T> {
	fn batch(c: u32, ) -> Weight {
		(22_202_000 as Weight)
			// Standard Error: 1_000
			.saturating_add((6_097_000 as Weight).saturating_mul(c as Weight))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		(26_060_000 as Weight)
			...
			.saturating_add((6_698_000 as Weight).saturating_mul(c as Weight))
	}
	fn dispatch_as() -> Weight {
		(18_128_000 as Weight)
	}
}
