...
impl<T: frame_system::Config> utility::WeightInfo for WeightInfo<T> {
	fn batch(c: u32, ) -> Weight {
		(40_078_000 as Weight)
			...
			.saturating_add((7_008_000 as Weight).saturating_mul(c as Weight))
	}
	...
	fn batch_all(c: u32, ) -> Weight {
		(4_620_000 as Weight)
			...
			.saturating_add((7_650_000 as Weight).saturating_mul(c as Weight))
	...
	fn force_batch(c: u32, ) -> Weight {
		(40_906_000 as Weight)
			// Standard Error: 6_000
			.saturating_add((6_915_000 as Weight).saturating_mul(c as Weight))
	}
}
