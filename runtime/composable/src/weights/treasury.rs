...
impl<T: frame_system::Config> treasury::WeightInfo for WeightInfo<T> {
	...
	fn approve_proposal(p: u32, ) -> Weight {
		(12_934_000 as Weight)
			...
			.saturating_add((1_337_000 as Weight).saturating_mul(p as Weight))
	...
	fn on_initialize_proposals(p: u32, ) -> Weight {
		(67_165_000 as Weight)
			// Standard Error: 136_000
			.saturating_add((64_434_000 as Weight).saturating_mul(p as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
