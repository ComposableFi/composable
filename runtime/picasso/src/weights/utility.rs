...
impl<T: frame_system::Config> utility::WeightInfo for WeightInfo<T> {
	fn batch(c: u32, ) -> Weight {
		(24_789_000 as Weight)
			...
			.saturating_add((6_100_000 as Weight).saturating_mul(c as Weight))
	}
	fn as_derivative() -> Weight {
		(4_360_000 as Weight)
	}
	fn batch_all(c: u32, ) -> Weight {
		(14_444_000 as Weight)
			// Standard Error: 5_000
			.saturating_add((6_667_000 as Weight).saturating_mul(c as Weight))
	}
	fn dispatch_as() -> Weight {
		(19_225_000 as Weight)
	}
}
