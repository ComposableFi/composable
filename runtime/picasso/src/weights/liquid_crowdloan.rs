...
//! Autogenerated weights for liquid_crowdloan
//!
...
/// Weight functions for liquid_crowdloan.
pub struct WeightInfo<T>(PhantomData<T>);
impl<T: frame_system::Config> liquid_crowdloan::WeightInfo for WeightInfo<T> {
	fn initiate() -> Weight {
