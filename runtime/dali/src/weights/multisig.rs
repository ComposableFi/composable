...
impl<T: frame_system::Config> multisig::WeightInfo for WeightInfo<T> {
	...
	fn as_multi_complete(s: u32, z: u32, ) -> Weight {
		(85_024_000 as Weight)
			// Standard Error: 184_000
			.saturating_add((936_000 as Weight).saturating_mul(s as Weight))
			// Standard Error: 0
	...
	fn approve_as_multi_complete(s: u32, ) -> Weight {
		(121_332_000 as Weight)
			...
			.saturating_add((758_000 as Weight).saturating_mul(s as Weight))
			.saturating_add(T::DbWeight::get().reads(4 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
	// Storage: Multisig Multisigs (r:1 w:1)
