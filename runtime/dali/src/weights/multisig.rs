...
impl<T: frame_system::Config> multisig::WeightInfo for WeightInfo<T> {
	...
	fn as_multi_approve(s: u32, z: u32, ) -> Weight {
		(0 as Weight)
			// Standard Error: 2_389_000
			.saturating_add((26_515_000 as Weight).saturating_mul(s as Weight))
			// Standard Error: 0
	...
	// Storage: Multisig Multisigs (r:1 w:1)
	// Storage: Multisig Calls (r:1 w:1)
	fn as_multi_approve_store(_s: u32, _z: u32, ) -> Weight {
		(415_621_000 as Weight)
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
	}
	// Storage: Multisig Multisigs (r:1 w:1)
