...
impl<T: frame_system::Config> multisig::WeightInfo for WeightInfo<T> {
	...
	fn as_multi_create(s: u32, z: u32, ) -> Weight {
		(60_304_000 as Weight)
			...
			.saturating_add((587_000 as Weight).saturating_mul(s as Weight))
			// Standard Error: 0
	...
	fn as_multi_approve_store(s: u32, z: u32, ) -> Weight {
		(63_811_000 as Weight)
			...
			.saturating_add((682_000 as Weight).saturating_mul(s as Weight))
			// Standard Error: 0
			.saturating_add((3_000 as Weight).saturating_mul(z as Weight))
			.saturating_add(T::DbWeight::get().reads(2 as Weight))
			.saturating_add(T::DbWeight::get().writes(2 as Weight))
