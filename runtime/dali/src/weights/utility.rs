...
impl<T: frame_system::Config> utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		(31_638_000 as Weight)
			...
			.saturating_add((11_075_000 as Weight).saturating_mul(c as Weight))
	...
	fn batch_all(c: u32, ) -> Weight {
		(0 as Weight)
			...
			.saturating_add((12_387_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		(49_972_000 as Weight)
			// Standard Error: 10_000
			.saturating_add((11_074_000 as Weight).saturating_mul(c as Weight))
			.saturating_add(T::DbWeight::get().reads(1 as Weight))
	}
}
