...
impl<T: frame_system::Config> oracle::WeightInfo for WeightInfo<T> {
	...
	fn submit_price(p: u32, ) -> Weight {
		(56_037_000 as Weight)
			...
			.saturating_add((288_000 as Weight).saturating_mul(p as Weight))
	...
	fn update_price(p: u32, ) -> Weight {
		(42_457_000 as Weight)
			// Standard Error: 31_000
			.saturating_add((13_566_000 as Weight).saturating_mul(p as Weight))
			.saturating_add(T::DbWeight::get().reads(3 as Weight))
