...
impl<T: frame_system::Config> lending::WeightInfo for WeightInfo<T> {
	...
	fn liquidate(b: u32, ) -> Weight {
		(19_381_000 as Weight)
			// Standard Error: 249_000
			.saturating_add((26_939_000 as Weight).saturating_mul(b as Weight))
