...
impl<T: frame_system::Config> lending::WeightInfo for WeightInfo<T> {
	...
	fn liquidate(b: u32, ) -> Weight {
		(150_762_000 as Weight)
			...
			.saturating_add((26_736_000 as Weight).saturating_mul(b as Weight))
	...
	fn accrue_interest(x: u32, ) -> Weight {
		(86_518_000 as Weight)
			// Standard Error: 0
			.saturating_add((14_000 as Weight).saturating_mul(x as Weight))
