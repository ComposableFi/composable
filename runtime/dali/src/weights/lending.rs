...
impl<T: frame_system::Config> lending::WeightInfo for WeightInfo<T> {
	...
	fn liquidate(b: u32, ) -> Weight {
		(273_951_000 as Weight)
			// Standard Error: 38_000
			.saturating_add((25_013_000 as Weight).saturating_mul(b as Weight))
