...
impl<T: frame_system::Config> pallet_ibc::WeightInfo for WeightInfo<T> {
	...
	fn on_finalize(a: u32, b: u32, c: u32, d: u32, e: u32, f: u32, ) -> Weight {
		(51_302_000 as Weight)
			...
			.saturating_add((54_412_000 as Weight).saturating_mul(a as Weight))
			// Standard Error: 1_033_000
			.saturating_add((19_429_000 as Weight).saturating_mul(b as Weight))
			// Standard Error: 1_033_000
			.saturating_add((46_791_000 as Weight).saturating_mul(c as Weight))
			// Standard Error: 1_033_000
			.saturating_add((17_457_000 as Weight).saturating_mul(d as Weight))
			// Standard Error: 1_033_000
			.saturating_add((18_026_000 as Weight).saturating_mul(e as Weight))
			// Standard Error: 1_033_000
			.saturating_add((2_922_000 as Weight).saturating_mul(f as Weight))
