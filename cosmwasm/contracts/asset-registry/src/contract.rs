...
mod tests {
    ...
    fn register_unregister_assets() {
        ...
        let addr1 = AssetReference::Virtual {
            cw20_address: Addr::unchecked("addr1"),
        };
        let addr2 = AssetReference::Virtual {
            cw20_address: Addr::unchecked("addr2"),
        };
        let addr3 = AssetReference::Virtual {
            cw20_address: Addr::unchecked("addr3"),
        };
        let addr4 = AssetReference::Virtual {
            cw20_address: Addr::unchecked("addr4"),
        };
