...
with prelude; rec {
  ...
  mkCollator =
    ...
    }:
    {
      ...
      env = [{
        # https://github.com/paritytech/zombienet/issues/791
        name = "RUST_LOG";
        value = "trace";
        #,=trace,pallet_ibc=trace,grandpa-verifier=trace,parachain=trace,cumulus-collator=trace,aura=trace,xcm=trace";
