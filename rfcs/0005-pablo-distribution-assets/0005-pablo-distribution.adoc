...
[source,rust]
----
include::../../frame/composable-traits/src/staking/mod.rs[lines=122..138]
----

Which is referred to in the algorithms in the followin sections.

Now in order to allow redeeming the above fNFT, following data structures is to be tracked in the staking rewards pallet,

[source,rust]
----
include::../../frame/composable-traits/src/staking/mod.rs[lines=20..40]
----

[source,rust]
----
include::../../frame/composable-traits/src/staking/mod.rs[lines=61..79]
----
