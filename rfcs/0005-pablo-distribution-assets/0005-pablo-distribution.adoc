...
. Each staked position MUST be represented as a https://github.com/ComposableFi/composable/tree/main/code/parachain/frame/fnft[fNFT].
...
[source,rust]
----
include::../../code/parachain/frame/composable-traits/src/dex.rs[lines=185..196]
----
...
[source,rust]
----
include::../../code/parachain/frame/composable-traits/src/staking/mod.rs[lines=205..231]
----
...
[source,rust]
----
include::../../code/parachain/frame/composable-traits/src/staking/mod.rs[lines=17..42]
----

[source,rust]
----
include::../../code/parachain/frame/composable-traits/src/staking/mod.rs[lines=106..146]
----
...
while (assetId = stake_pools.has_next) is (yes)
    ...
    while (reward = rewards_pool.rewards.has_next) is (yes)
        ...
        note left
            ...
            the pool will pause. it will recover
            once enough rewards are accumulated.
        endnote
