    ...
    PausableUpgradeable
{
    ...
    /// @notice executes fallback call
    /// @param _id initially generated id
    /// @param _contract contract where the call is forwarded to
    /// @param _data encoded data used in this call
    ...
    {
        require(hasBeenForwarded[_id], "Call hasn't  forwarded");

        // solhint-disable-next-line avoid-low-level-calls
        (success, returnData) = _contract.excessivelySafeCall(_gas, 32, _data, msg.value);
        require(success, "Failed to execute fallback function call");
    }
    ...
    /// @param _data destinationContract, destinationData, fallbackContract, fallbackData
