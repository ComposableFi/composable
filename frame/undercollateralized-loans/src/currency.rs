...
///
/// ```
/// # use pallet_undercollateralized_loans::currency::Currency;
///
...
impl<const ID: u128, const EXPONENT: u8> Currency<ID, EXPONENT> {
	...
	/// [`Self::ONE`](pallet_undercollateralized_loans::currency::Currency::ONE), saturating at the
...
///
/// ```rust
/// # use pallet_undercollateralized_loans::currency::{Currency, RuntimeCurrency};
/// type ACOIN = Currency<12345, 10>;
