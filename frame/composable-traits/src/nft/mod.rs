...
//!
//! In both cases XCMP NFT state as whole requires protocol constraints, like immutability or
//! protocol implementation on other side. In both cases RPC or shared library is required to
//! interpret state offchain.
//!
//! Problem with NFT as it is considered isolated, while burn, split, mint in protocols influence
//! total/shared.
pub mod protocol;
