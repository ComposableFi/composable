...
pub trait AirdropManagement {
    ...
    fn create_airdrop(start: Self::AirdropStart, schedule: Self::VestingSchedule) -> DispatchResult;

    /// Add one or more recipients to an Airdrop.
    fn add_recipient(airdrop_id: Self::AirdropId, recipients: Self::RecipientCollection) -> DispatchResult;
