...
fn create_pool(assets: Vec<AssetId>, amounts: Vec<Balance>, fee: Permill, admin_fee: Permill) -> PoolId {
...
fn test_get_price() {
	new_test_ext().execute_with(|| {
        ...
        let eth_price = ConstantProductAmm::get_price(pool_id, MockCurrencyId::ETH, 1u128);
        assert_ok!(eth_price);
        ...
        let usdt_price = ConstantProductAmm::get_price(pool_id, MockCurrencyId::USDT, 3100u128);
