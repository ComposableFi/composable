...
pub const BASE_RETURNED_AFTER_ADDING_QUOTE: Balance = 00039215686274509804; // 0.039 units
...
pub const BASE_REQUIRED_FOR_REMOVING_QUOTE: Balance = 00040816326530612244; // 0.040 units
