...
<img src="images/images/apollo-overview.png" width="1315" height="1023" alt="apollo overview" />
...
<img src="images/images/price.png" width="175" height="100" alt="price" />
...
<img src="images/images/asset-info.png" width="476" height="263" alt="asset info" />
...
Figure 2. Offchain Worker: check\_requests
...
Figure 3. Offchain Worker: is\_requested
...
Figure 4. Offchain Worker: fetch\_price\_and\_send\_signed
...
Figure 5. on\_initialize: update\_prices

This algorithm is `O(A * P)` Where `A` = number of assets and `P` =
number of prices, i.e in the order of the number of assets the prices
are required for, by the oracle. Possibly requires optimization to scale
so that it won’t take up the entire block weight.

<img src="images/images/update-prices-1-update-pre-prices.png" width="641" height="355" alt="update prices 1 update pre prices" />

Figure 6. update\_prices: update\_pre\_prices prunes PrePrices storage
...
Figure 7. update\_pre\_prices: prune\_old\_pre\_prices prunes PrePrices
...
<td>AnswerInTransit seems not to be used for anything?</td>
</tr>
</tbody>
</table>
...
Figure 8. update\_prices: update\_price calculates and updates the
...
Figure 9. update\_price: calculate\_price calculates the actual price
for asset

<img src="images/images/calculate-price-1-get-median-price.png" width="532" height="555" alt="calculate price 1 get median price" />

Figure 10. calculate\_price: get\_median\_price calculates the median
price for an asset among pre-prices

<img src="images/images/update-price-2-handle-payout.png" width="667" height="623" alt="update price 2 handle payout" />

Figure 11. update\_price: handle\_payout pays the reward out
...
Last updated 2022-07-21 13:18:19 +0200
