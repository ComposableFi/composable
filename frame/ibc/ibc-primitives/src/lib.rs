...
pub struct SendPacketData {
	/// packet data
	pub data: Vec<u8>,
	/// Block height on the counterparty chain when this packet should be invalidated relative to
	/// the latest height
	pub timeout_height_offset: u64,
	/// Timestamp on counterparty chain when this packet should be invalidated relative to the
	/// latest timestamp This value should be in nano seconds
