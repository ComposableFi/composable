...
pub mod pallet {
	...
	use crate::mocks::{currency::*, Balance};
	...
	impl<T: Config> Oracle for Pallet<T> {
		...
		fn get_price(
			...
			match asset {
				...
				*/
				USDT => Ok(Price { price: amount, block: () }),
				PICA => derive_price(10_00, amount),
				BTC => derive_price(Self::btc_value(), amount),
				ETH => derive_price(3400_00, amount),
				LTC => derive_price(180_00, amount),
