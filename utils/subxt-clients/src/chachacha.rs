...
pub mod api {
		...
		pub mod calls {
				...
				T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>,
			{
				...
				pub fn report_equivocation(
					...
					let call = ReportEquivocation { equivocation_proof, key_owner_proof };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
				pub fn report_equivocation_unsigned(
					...
					let call = ReportEquivocationUnsigned { equivocation_proof, key_owner_proof };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
		...
		pub mod calls {
				...
				T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>,
			{
				...
				pub fn note_stalled(
					...
					let call = NoteStalled { delay, best_finalized_block_number };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
			}
		}
		...
		pub mod calls {
				...
				T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>,
			{
				...
				pub fn force_schedule_code_upgrade(
					...
					let call = ForceScheduleCodeUpgrade { para, new_code, relay_parent_number };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
	...
	pub mod paras_disputes {
		...
		pub mod calls {
				...
				T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>,
			{
				...
				pub fn force_unfreeze(&self) -> ::subxt::SubmittableExtrinsic<T, ForceUnfreeze> {
		...
		pub mod storage {
			...
			impl<'a, T: ::subxt::Config> StorageApi<'a, T> {
				...
				pub async fn disputes_iter(
					&self,
					hash: ::core::option::Option<T::Hash>,
				) -> ::core::result::Result<::subxt::KeyIter<'a, T, Disputes>, ::subxt::Error> {
					self.client.storage().iter(hash).await
				}
				pub async fn included(
					&self,
				...
				pub async fn included_iter(
					&self,
					hash: ::core::option::Option<T::Hash>,
				) -> ::core::result::Result<::subxt::KeyIter<'a, T, Included>, ::subxt::Error> {
					self.client.storage().iter(hash).await
				}
				...
				pub async fn spam_slots_iter(
					&self,
					hash: ::core::option::Option<T::Hash>,
				) -> ::core::result::Result<::subxt::KeyIter<'a, T, SpamSlots>, ::subxt::Error> {
					self.client.storage().iter(hash).await
				}
				pub async fn frozen(
					&self,
		...
		pub mod calls {
				...
				T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>,
			{
				...
				pub fn register(
					...
					let call = Register { id, genesis_head, validation_code };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
				pub fn force_register(
					...
					let call = ForceRegister { who, deposit, id, genesis_head, validation_code };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
				pub fn deregister(
					&self,
		...
		pub mod calls {
				...
				T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>,
			{
				...
				pub fn new_auction(
					...
					let call = NewAuction { duration, lease_period_index };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
				pub fn bid(
					&self,
					...
					let call = Bid { para, auction_index, first_slot, last_slot, amount };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
		...
		pub mod calls {
				...
				T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>,
			{
				...
				pub fn create(
					...
					let call = Create { index, cap, first_period, last_period, end, verifier };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
				pub fn contribute(
					&self,
					...
					let call = Contribute { index, value, signature };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
				pub fn withdraw(
					&self,
				...
				pub fn edit(
					...
					let call = Edit { index, cap, first_period, last_period, end, verifier };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
				pub fn add_memo(
					&self,
		...
		pub mod calls {
				...
				T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>,
			{
				...
				pub fn force_lease(
					...
					let call = ForceLease { para, leaser, amount, period_begin, period_count };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
	...
	pub mod utility {
		...
		pub mod calls {
			...
			pub struct DispatchAs {
				pub as_origin: runtime_types::rococo_runtime::OriginCaller,
				pub call: runtime_types::rococo_runtime::Call,
			}
		...
		pub mod calls {
				...
				T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>,
			{
				...
				pub fn proxy(
					...
					let call = Proxy { real, force_proxy_type, call };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
				pub fn add_proxy(
					&self,
				...
				pub fn proxy_announced(
					...
					let call = ProxyAnnounced { delegate, real, force_proxy_type, call };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
			}
		}
		...
		pub mod calls {
				...
				T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>,
			{
				...
				pub fn as_multi_threshold1(
					...
					let call = AsMultiThreshold1 { other_signatories, call };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
				pub fn as_multi(
					&self,
				...
				pub fn cancel_as_multi(
					...
					let call = CancelAsMulti { threshold, other_signatories, timepoint, call_hash };
					::subxt::SubmittableExtrinsic::new(self.client, call)
				}
			}
		}
	...
	pub mod xcm_pallet {
		...
		pub mod storage {
			...
			impl ::subxt::StorageEntry for VersionNotifyTargets {
				...
				type Value =
					(::core::primitive::u64, ::core::primitive::u64, ::core::primitive::u32);
				fn key(&self) -> ::subxt::StorageEntryKey {
					::subxt::StorageEntryKey::Map(vec![
						::subxt::StorageMapKey::new(&self.0, ::subxt::StorageHasher::Twox64Concat),
						::subxt::StorageMapKey::new(
	...
	pub mod runtime_types {
		...
		pub mod pallet_im_online {
			...
			pub mod pallet {
				...
				pub enum Event {
					...
					AllGood,
					#[codec(index = 2)]
					SomeOffline(::std::vec::Vec<(::subxt::sp_core::crypto::AccountId32, ())>),
				}
			}
			pub mod sr25519 {
				use super::runtime_types;
			...
			pub mod hrmp {
				...
				pub mod pallet {
					...
					pub enum Call {
						...
						#[codec(index = 3)]
						force_clean_hrmp { para: runtime_types::polkadot_parachain::primitives::Id },
						#[codec(index = 4)]
		...
		pub mod rococo_runtime {
			...
			pub enum Call {
				...
				#[codec(index = 35)]
				ValidatorManager(runtime_types::rococo_runtime::validator_manager::Call),
				#[codec(index = 80)]
			...
			pub enum Event {
				...
				#[codec(index = 35)]
				ValidatorManager(
					runtime_types::rococo_runtime::validator_manager::RawEvent<
						::subxt::sp_core::crypto::AccountId32,
					>,
				),
				#[codec(index = 80)]
		...
		T: ::subxt::Config + ::subxt::ExtrinsicExtraData<T>,
	{
		...
		pub fn paras_disputes(&self) -> paras_disputes::calls::TransactionApi<'a, T> {
		...
		pub fn validator_manager(&self) -> validator_manager::calls::TransactionApi<'a, T> {
