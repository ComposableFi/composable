    ...
    pub mod runtime_types {
        ...
        pub mod cumulus_pallet_parachain_system {
            ...
            pub mod pallet {
                ...
                #[derive(::subxt::codec::Encode, ::subxt::codec::Decode)]
                pub enum Call {
                    set_upgrade_block { relay_chain_block: ::core::primitive::u32 },
                    set_validation_data { data: runtime_types::cumulus_primitives_parachain_inherent::ParachainInherentData },
                    sudo_send_upward_message { message: ::std::vec::Vec<::core::primitive::u8> },
                    authorize_upgrade { code_hash: ::subxt::sp_core::H256 },
                    enact_authorized_upgrade { code: ::std::vec::Vec<::core::primitive::u8> },
                }
