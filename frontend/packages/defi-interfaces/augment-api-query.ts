...
declare module '@polkadot/api-base/types/storage' {
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    airdrop: {
       ...
       **/
      airdropCount: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Airdrops currently stored by the pallet.
       **/
      airdrops: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletAirdropModelsAirdrop>>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * Associations of local accounts and an [`AirdropId`](Config::AirdropId) to a remote account.
       **/
      associations: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: AccountId32 | string | Uint8Array) => Observable<Option<PalletAirdropModelsIdentity>>, [u128, AccountId32]> & QueryableStorageEntry<ApiType, [u128, AccountId32]>;
      /**
       * Recipient funds of Airdrops stored by the pallet.
       **/
      recipientFunds: AugmentedQuery<ApiType, (arg1: u128 | AnyNumber | Uint8Array, arg2: PalletAirdropModelsIdentity | { RelayChain: any } | { Ethereum: any } | { Cosmos: any } | string | Uint8Array) => Observable<Option<PalletAirdropModelsRecipientFund>>, [u128, PalletAirdropModelsIdentity]> & QueryableStorageEntry<ApiType, [u128, PalletAirdropModelsIdentity]>;
      totalAirdropRecipients: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<u32>, [u128]> & QueryableStorageEntry<ApiType, [u128]>;
      /**
       * Generic query
       **/
    ...
    stakingRewards: {
      ...
      rewardPools: AugmentedQuery<ApiType, (arg: u16 | AnyNumber | Uint8Array) => Observable<Option<ComposableTraitsStakingRewardPool>>, [u16]> & QueryableStorageEntry<ApiType, [u16]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
