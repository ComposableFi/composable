...
declare module "@polkadot/api-base/types/submittable" {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    cosmwasm: {
       ...
       **/
      clearAdmin: AugmentedSubmittable<
        (
      ...
      migrate: AugmentedSubmittable<
        ...
        [AccountId32, PalletCosmwasmCodeIdentifier, u64, Bytes]
      >;
      /**
       ...
       * * `gas` the maximum gas to use, the remaining is refunded at the end of the transaction.
       **/
      updateAdmin: AugmentedSubmittable<
        (
          contract: AccountId32 | string | Uint8Array,
          newAdmin: AccountId32 | string | Uint8Array,
          gas: u64 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32, AccountId32, u64]
      >;
      /**
    ...
    crowdloanRewards: {
      ...
      >;
      unlockRewardsFor: AugmentedSubmittable<
        (
          rewardAccounts:
            | Vec<AccountId32>
    ...
    dexRouter: {
      ...
      buy: AugmentedSubmittable<
        (
          inAssetId: u128 | AnyNumber | Uint8Array,
          outAsset:
            | ComposableTraitsDexAssetAmount
        ...
        [u128, ComposableTraitsDexAssetAmount]
      >;
      /**
    ...
    pablo: {
      ...
      addLiquidity: AugmentedSubmittable<
        ...
        [u128, BTreeMap<u128, u128>, u128, bool]
      >;
      /**
      ...
      buy: AugmentedSubmittable<
        ...
        [u128, u128, ComposableTraitsDexAssetAmount, bool]
      >;
      /**
    ...
    vesting: {
      ...
      updateVestingSchedules: AugmentedSubmittable<
        ...
        [MultiAddress, u128, Vec<ComposableTraitsVestingVestingScheduleInfo>]
      >;
      /**
