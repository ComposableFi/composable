...
import { Connectors, HooksState } from "../workaround-web3-react-issues-379/HooksStore";
...
export type NonStaticConnectorType = Exclude<ConnectorType, ConnectorType.Static>
...
export const useConnector = (type: NonStaticConnectorType) : Connector => {
  const connectors = useSelector<HooksState, any>((state) => state.connectors as Connectors);
