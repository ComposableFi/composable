 ...
 */
export declare type ExtrinsicStatus = 'isReady' | 'isBroadcast' | 'isInBlock' | 'isFinalized' | 'Error';
/**
...
export interface ExtrinsicSlice {
    ...
    addExtrinsic: (transactionHash: string, extrinsicCall: Omit<ExtrinsicMetadata, 'dispatchError'>) => void;
    updateExtrinsicStatus: (transactionHash: string, status: ExtrinsicStatus) => void;
