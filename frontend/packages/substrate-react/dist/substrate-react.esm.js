...
var usePendingExtrinsic = function usePendingExtrinsic(method, section, sender) {
  ...
  var _isPendingExtrinsic = useMemo(function () {
...
var useExtrinsicCalls = function useExtrinsicCalls(method, section, sender) {
  ...
  var extrinsicCalls = useMemo(function () {
    var calls = [];
...
var ExecutorContext = /*#__PURE__*/React.createContext({
  executor: undefined
});
var ExecutorProvider = function ExecutorProvider(_ref) {
  ...
  return React.createElement(ExecutorContext.Provider, {
    value: {
      executor: executor
    }
  }, children);
...
var DotsamaContext = /*#__PURE__*/createContext({
...
var DotSamaContextProvider = function DotSamaContextProvider(_ref3) {
  ...
  var _useState = useState(PARACHAIN_PROVIDERS_DEFAULT),
      parachainProviders = _useState[0],
      setParachainProviders = _useState[1];

  var _useState2 = useState(RELAYCHAIN_PROVIDERS_DEFAULT),
  ...
  useEffect(function () {
    var _loop3 = function _loop3(i) {
      ...
      var wsProvider = new WsProvider(rpcUrl);
      var parachainApi = new ApiPromise({
        provider: wsProvider,
        rpc: rpc,
        types: types
      });
  ...
  return React.createElement(DotsamaContext.Provider, {
    value: _extends({
...
var useParachainApi = function useParachainApi(parachainId) {
  var _React$useContext = React.useContext(DotsamaContext),
...
var useRelayChainApi = function useRelayChainApi(relaychainId) {
  var _React$useContext2 = React.useContext(DotsamaContext),
...
var useSelectedAccount = function useSelectedAccount(parachainId) {
  var _React$useContext3 = React.useContext(DotsamaContext),
...
export { DotSamaContextProvider, DotsamaContext, ExecutorProvider, ParachainNetworks, RelayChainNetworks, getParachainNetwork, getRelaychainNetwork, getSigner, useDotSamaContext, useExecutor, useExtrinsicCalls, useExtrinsics, useParachainApi, usePendingExtrinsic, useRelayChainApi, useSelectedAccount };
//# sourceMappingURL=substrate-react.esm.js.map
