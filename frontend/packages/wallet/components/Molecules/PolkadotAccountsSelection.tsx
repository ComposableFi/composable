...
export const PolkadotAccountsSelection = ({ accounts, onSelect, selectedAccount, disconnectWallet }: {
            ...
            >
                {accounts.map((account) => (
                    <PolkadotAccountListItem
                        ...
                        isSelected={selectedActiveAccount?.address === account.address ?? false}
                    />
                ))}
