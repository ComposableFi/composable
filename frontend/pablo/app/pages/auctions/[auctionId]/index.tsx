...
import { AuctionStatusIndicator, Link, TabItem, Tabs, TabPanel } from "@/components";
...
const Auction: NextPage = () => {
  ...
  const { liquidityBootstrappingPools, putLBPSpotPrice, resetActiveLBP, auctions: { activeLBP, activeLBPStats, activeChart } } = useLiquidityBootstrappingPoolStore();
      ...
      const interval = setInterval(() => {
        ...
        for (
          ...
          retrieveSpotPrice(
            ...
            console.log('Sp', spotPrice.toFixed(4))
  ...
  const isActive: boolean = activeLBP.sale.start <= currentTimestamp 
      ...
      <Container maxWidth="lg">
        <Box mb={25}>
          ...
          >
            ...
            <AuctionInformation stats={activeLBPStats} auction={activeLBP} mt={6} />
