...
import type { PalletPabloPoolInitConfiguration } from "@/defi/polkadot/interfaces/pablo";
  ...
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    assets: {
      ...
      burnFrom: AugmentedSubmittable<
        ...
        [u128, MultiAddress, Compact<u128>]
      >;
      /**
      ...
      forceTransfer: AugmentedSubmittable<
        (
          asset: u128 | AnyNumber | Uint8Array,
          source:
            | MultiAddress
            | { Id: any }
            | { Index: any }
        ...
        [u128, MultiAddress, MultiAddress, Compact<u128>, bool]
      >;
      /**
       ...
       * - If the `dest` cannot be looked up.
       **/
      forceTransferNative: AugmentedSubmittable<
        (
          source:
            | MultiAddress
            | { Id: any }
        ...
        [MultiAddress, MultiAddress, Compact<u128>, bool]
      >;
      /**
       ...
       **/
      mintInitialize: AugmentedSubmittable<
        (
          amount: Compact<u128> | AnyNumber | Uint8Array,
          dest:
            | MultiAddress
       ...
       **/
      mintInitializeWithGovernance: AugmentedSubmittable<
        (
          amount: Compact<u128> | AnyNumber | Uint8Array,
          governanceOrigin:
            | MultiAddress
      ...
      transfer: AugmentedSubmittable<
        ...
        [u128, MultiAddress, Compact<u128>, bool]
      >;
      /**
       ...
       * - If the `dest` cannot be looked up.
       **/
      transferAllNative: AugmentedSubmittable<
        (
          dest:
            | MultiAddress
            | { Id: any }
      ...
      transferNative: AugmentedSubmittable<
        ...
        [MultiAddress, Compact<u128>, bool]
      >;
      /**
       * Generic tx
       **/
    ...
    assetsRegistry: {
      ...
      registerAsset: AugmentedSubmittable<
        (
          location: ComposableTraitsXcmAssetsXcmAssetLocation | { parents?: any; interior?: any } | string | Uint8Array,
          ed: u128 | AnyNumber | Uint8Array,
          ratio: Option<u128> | null | object | string | Uint8Array,
          decimals: Option<u32> | null | object | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [ComposableTraitsXcmAssetsXcmAssetLocation, u128, Option<u128>, Option<u32>]
      >;
      /**
       ...
       **/
      setMinFee: AugmentedSubmittable<
        (
          targetParachainId: u32 | AnyNumber | Uint8Array,
          foreignAssetId:
            | ComposableTraitsXcmAssetsXcmAssetLocation
            | { parents?: any; interior?: any }
            | string
            | Uint8Array,
          amount: Option<u128> | null | object | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u32, ComposableTraitsXcmAssetsXcmAssetLocation, Option<u128>]
      >;
      /**
      ...
      updateAsset: AugmentedSubmittable<
        ...
        [u128, ComposableTraitsXcmAssetsXcmAssetLocation, Option<u128>, Option<u32>]
      >;
      /**
       * Generic tx
       **/
    ...
    bondedFinance: {
      ...
      bond: AugmentedSubmittable<
        (
          offerId: u128 | AnyNumber | Uint8Array,
          nbOfBonds: u128 | AnyNumber | Uint8Array,
          keepAlive: bool | boolean | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128, u128, bool]
      >;
       ...
       * Emits a `NewOffer`.
       **/
      offer: AugmentedSubmittable<
        (
          offer:
            | ComposableTraitsBondedFinanceBondOffer
            | { beneficiary?: any; asset?: any; bondPrice?: any; nbOfBonds?: any; maturity?: any; reward?: any }
            | string
            | Uint8Array,
          keepAlive: bool | boolean | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [ComposableTraitsBondedFinanceBondOffer, bool]
      >;
      /**
       * Generic tx
       **/
    ...
    callFilter: {
       ...
       **/
      disable: AugmentedSubmittable<
        (
          entry:
            | ComposableTraitsCallFilterCallFilterEntry
            | { palletName?: any; functionName?: any }
            | string
            | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [ComposableTraitsCallFilterCallFilterEntry]
    ...
    crowdloanRewards: {
       ...
       * ```
       **/
      associate: AugmentedSubmittable<
        (
          rewardAccount: AccountId32 | string | Uint8Array,
          proof: PalletCrowdloanRewardsModelsProof | { RelayChain: any } | { Ethereum: any } | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
    ...
    dexRouter: {
      ...
      addLiquidity: AugmentedSubmittable<
        (
          assetPair: ComposableTraitsDefiCurrencyPairCurrencyId | { base?: any; quote?: any } | string | Uint8Array,
          baseAmount: u128 | AnyNumber | Uint8Array,
          quoteAmount: u128 | AnyNumber | Uint8Array,
          minMintAmount: u128 | AnyNumber | Uint8Array,
          keepAlive: bool | boolean | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [ComposableTraitsDefiCurrencyPairCurrencyId, u128, u128, u128, bool]
      >;
      /**
      ...
      buy: AugmentedSubmittable<
        (
          assetPair: ComposableTraitsDefiCurrencyPairCurrencyId | { base?: any; quote?: any } | string | Uint8Array,
          amount: u128 | AnyNumber | Uint8Array,
          minReceive: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [ComposableTraitsDefiCurrencyPairCurrencyId, u128, u128]
      >;
      /**
       * Exchange `amount` of quote asset for `asset_pair` via route found in router.
       * On successful underlying DEX pallets will emit appropriate event
       **/
      exchange: AugmentedSubmittable<
        (
          assetPair: ComposableTraitsDefiCurrencyPairCurrencyId | { base?: any; quote?: any } | string | Uint8Array,
          amount: u128 | AnyNumber | Uint8Array,
          minReceive: u128 | AnyNumber | Uint8Array
      ...
      removeLiquidity: AugmentedSubmittable<
        (
          ...
          minBaseAmount: u128 | AnyNumber | Uint8Array,
          minQuoteAmount: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [ComposableTraitsDefiCurrencyPairCurrencyId, u128, u128, u128]
      >;
      /**
       ...
       **/
      updateRoute: AugmentedSubmittable<
        (
          assetPair: ComposableTraitsDefiCurrencyPairCurrencyId | { base?: any; quote?: any } | string | Uint8Array,
          route: Option<Vec<u128>> | null | object | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [ComposableTraitsDefiCurrencyPairCurrencyId, Option<Vec<u128>>]
      >;
      /**
       * Generic tx
       **/
    ...
    dutchAuction: {
       ...
       **/
      addConfiguration: AugmentedSubmittable<
        (
          configurationId: u128 | AnyNumber | Uint8Array,
          configuration:
            | ComposableTraitsTimeTimeReleaseFunction
            | { LinearDecrease: any }
        ...
        [u128, ComposableTraitsTimeTimeReleaseFunction]
      >;
      /**
       * sell `order` in auction with `configuration`
       * some deposit is taken for storing sell order
       **/
      ask: AugmentedSubmittable<
        (
          order: ComposableTraitsDefiSellCurrencyId | { pair?: any; take?: any } | string | Uint8Array,
          configuration:
            | ComposableTraitsTimeTimeReleaseFunction
            | { LinearDecrease: any }
            | { StairstepExponentialDecrease: any }
      ...
      liquidate: AugmentedSubmittable<
        (orderId: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u128]
      >;
      /**
       * adds take to list, does not execute take immediately
       **/
      take: AugmentedSubmittable<
        (
          orderId: u128 | AnyNumber | Uint8Array,
          take: ComposableTraitsDefiTake | { amount?: any; limit?: any } | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128, ComposableTraitsDefiTake]
      >;
      xcmSell: AugmentedSubmittable<
        (
          request:
            | ComposableTraitsXcmXcmSellRequest
            | { orderId?: any; fromTo?: any; order?: any; configuration?: any }
            | string
            | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [ComposableTraitsXcmXcmSellRequest]
    ...
    governanceRegistry: {
       ...
       **/
      grantRoot: AugmentedSubmittable<
      ...
      set: AugmentedSubmittable<
        (
          assetId: u128 | AnyNumber | Uint8Array,
          value: AccountId32 | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128, AccountId32]
      >;
      /**
    ...
    lending: {
      ...
      borrow: AugmentedSubmittable<
        (
          ...
          amountToBorrow: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u32, u128]
      >;
      /**
       ...
       **/
      createMarket: AugmentedSubmittable<
        (
          input:
            | ComposableTraitsLendingCreateInput
      ...
      liquidate: AugmentedSubmittable<
        (
          marketId: u32 | AnyNumber | Uint8Array,
          borrowers: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[]
        ) => SubmittableExtrinsic<ApiType>,
        [u32, Vec<AccountId32>]
      >;
      /**
      ...
      updateMarket: AugmentedSubmittable<
        ...
        [u32, ComposableTraitsLendingUpdateInput]
      >;
      /**
    ...
    liquidations: {
      addLiquidationStrategy: AugmentedSubmittable<
        (
          configuraiton:
            | PalletLiquidationsLiquidationStrategyConfiguration
            | { DutchAuction: any }
      ...
      sell: AugmentedSubmittable<
        (
          order: ComposableTraitsDefiSellCurrencyId | { pair?: any; take?: any } | string | Uint8Array,
          configuration: Vec<u32> | (u32 | AnyNumber | Uint8Array)[]
        ) => SubmittableExtrinsic<ApiType>,
        [ComposableTraitsDefiSellCurrencyId, Vec<u32>]
      >;
      /**
       * Generic tx
       **/
    ...
    mosaic: {
       ...
       **/
      acceptTransfer: AugmentedSubmittable<
        (
          from: AccountId32 | string | Uint8Array,
          networkId: u32 | AnyNumber | Uint8Array,
          remoteAssetId: CommonMosaicRemoteAssetId | { EthereumTokenAddress: any } | string | Uint8Array,
          amount: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
       ...
       * picked them up.
       **/
      claimStaleTo: AugmentedSubmittable<
        (
          assetId: u128 | AnyNumber | Uint8Array,
          to: AccountId32 | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
      ...
      rescindTimelockedMint: AugmentedSubmittable<
        (
          ...
          untrustedAmount: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u32, CommonMosaicRemoteAssetId, AccountId32, u128]
      >;
      /**
       ...
       **/
      rotateRelayer: AugmentedSubmittable<
        (
          updated: AccountId32 | string | Uint8Array,
          validatedTtl: u32 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32, u32]
      >;
      /**
      ...
      setBudget: AugmentedSubmittable<
        (
          assetId: u128 | AnyNumber | Uint8Array,
          amount: u128 | AnyNumber | Uint8Array,
          decay: PalletMosaicDecayBudgetPenaltyDecayer | { Linear: any } | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128, u128, PalletMosaicDecayBudgetPenaltyDecayer]
      >;
      /**
       ...
       * Only callable by the current Relayer
       **/
      setNetwork: AugmentedSubmittable<
        (
          networkId: u32 | AnyNumber | Uint8Array,
          networkInfo:
            | PalletMosaicNetworkInfo
            | { enabled?: any; minTransferSize?: any; maxTransferSize?: any }
            | string
            | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
      ...
      setRelayer: AugmentedSubmittable<
        (relayer: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [AccountId32]
      >;
      /**
       ...
       * This can only be called by the [`ControlOrigin`](Config::ControlOrigin)
       **/
      setTimelockDuration: AugmentedSubmittable<
      ...
      timelockedMint: AugmentedSubmittable<
        (
          ...
          to: AccountId32 | string | Uint8Array,
          amount: u128 | AnyNumber | Uint8Array,
          lockTime: u32 | AnyNumber | Uint8Array,
          id: H256 | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u32, CommonMosaicRemoteAssetId, AccountId32, u128, u32, H256]
      >;
      /**
       ...
       * - `AssetMappingUpdated`
       **/
      updateAssetMapping: AugmentedSubmittable<
        (
          assetId: u128 | AnyNumber | Uint8Array,
          networkId: u32 | AnyNumber | Uint8Array,
          remoteAssetId: Option<CommonMosaicRemoteAssetId> | null | object | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128, u32, Option<CommonMosaicRemoteAssetId>]
      >;
      /**
       * Generic tx
       **/
    ...
    oracle: {
       ...
       **/
      addAssetAndInfo: AugmentedSubmittable<
        (
          assetId: u128 | AnyNumber | Uint8Array,
          threshold: Percent | AnyNumber | Uint8Array,
          minAnswers: u32 | AnyNumber | Uint8Array,
          maxAnswers: u32 | AnyNumber | Uint8Array,
          blockInterval: u32 | AnyNumber | Uint8Array,
          reward: u128 | AnyNumber | Uint8Array,
          slash: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
       ...
       **/
      setSigner: AugmentedSubmittable<
        (signer: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [AccountId32]
      >;
      /**
       ...
       **/
      submitPrice: AugmentedSubmittable<
        (price: u128 | AnyNumber | Uint8Array, assetId: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u128, u128]
      >;
      /**
       * Generic tx
    ...
    pablo: {
      ...
      create: AugmentedSubmittable<
        ...
        [PalletPabloPoolInitConfiguration]
      >;
      enableTwap: AugmentedSubmittable<
        (poolId: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u128]
      >;
      /**
      ...
      swap: AugmentedSubmittable<
        (
          poolId: u128 | AnyNumber | Uint8Array,
          pair: ComposableTraitsDefiCurrencyPairCurrencyId | { base?: any; quote?: any } | string | Uint8Array,
          quoteAmount: u128 | AnyNumber | Uint8Array,
          minReceive: u128 | AnyNumber | Uint8Array,
          keepAlive: bool | boolean | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128, ComposableTraitsDefiCurrencyPairCurrencyId, u128, u128, bool]
      >;
      /**
       * Generic tx
       **/
    ...
    relayerXcm: {
      ...
      forceDefaultXcmVersion: AugmentedSubmittable<
        (maybeXcmVersion: Option<u32> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [Option<u32>]
      >;
      /**
      ...
      limitedReserveTransferAssets: AugmentedSubmittable<
        (
          ...
          weightLimit: XcmV2WeightLimit | { Unlimited: any } | { Limited: any } | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
    ...
    session: {
      ...
      setKeys: AugmentedSubmittable<
        (
          keys: DaliRuntimeOpaqueSessionKeys | { aura?: any } | string | Uint8Array,
          proof: Bytes | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [DaliRuntimeOpaqueSessionKeys, Bytes]
      >;
      /**
       * Generic tx
       **/
    ...
    vault: {
      addSurcharge: AugmentedSubmittable<
        (dest: u64 | AnyNumber | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u64, u128]
      >;
      /**
      ...
      claimSurcharge: AugmentedSubmittable<
        (
          dest: u64 | AnyNumber | Uint8Array,
          address: Option<AccountId32> | null | object | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u64, Option<AccountId32>]
      >;
      /**
      ...
      create: AugmentedSubmittable<
        (
          vault:
            | ComposableTraitsVaultVaultConfig
            | { assetId?: any; reserved?: any; manager?: any; strategies?: any }
            | string
            | Uint8Array,
          depositAmount: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [ComposableTraitsVaultVaultConfig, u128]
      >;
      deleteTombstoned: AugmentedSubmittable<
        (
          dest: u64 | AnyNumber | Uint8Array,
          address: Option<AccountId32> | null | object | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
      ...
      deposit: AugmentedSubmittable<
        (
          vault: u64 | AnyNumber | Uint8Array,
          assetAmount: u128 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u64, u128]
      >;
      /**
       ...
       **/
      emergencyShutdown: AugmentedSubmittable<
        (vault: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u64]
      >;
      /**
       ...
       **/
      liquidateStrategy: AugmentedSubmittable<
        (
          vaultIdx: u64 | AnyNumber | Uint8Array,
          strategyAccountId: AccountId32 | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u64, AccountId32]
      >;
      /**
      ...
      withdraw: AugmentedSubmittable<
        (vault: u64 | AnyNumber | Uint8Array, lpAmount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u64, u128]
      >;
      /**
       * Generic tx
    ...
    vesting: {
      ...
      vestedTransfer: AugmentedSubmittable<
        ...
        [MultiAddress, MultiAddress, u128, ComposableTraitsVestingVestingSchedule]
      >;
      /**
       * Generic tx
       **/
    ...
    xcmpQueue: {
      ...
      updateThresholdWeight: AugmentedSubmittable<
        (updated: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u64]
      >;
      /**
    ...
    xTokens: {
      ...
      transferMulticurrencies: AugmentedSubmittable<
        ...
        [Vec<ITuple<[u128, u128]>>, u32, XcmVersionedMultiLocation, u64]
      >;
      /**
      ...
      transferWithFee: AugmentedSubmittable<
        ...
        [u128, u128, u128, XcmVersionedMultiLocation, u64]
      >;
      /**
       * Generic tx
       **/
