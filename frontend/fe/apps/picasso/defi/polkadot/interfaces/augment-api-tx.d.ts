    ...
    interface AugmentedSubmittables<ApiType extends ApiTypes> {
        ...
        assetsRegistry: {
            ...
            registerAsset: AugmentedSubmittable<(location: ComposableTraitsXcmAssetsXcmAssetLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array, ed: u128 | AnyNumber | Uint8Array, ratio: Option<u128> | null | object | string | Uint8Array, decimals: Option<u32> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
            ...
            setMinFee: AugmentedSubmittable<(targetParachainId: u32 | AnyNumber | Uint8Array, foreignAssetId: ComposableTraitsXcmAssetsXcmAssetLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array, amount: Option<u128> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u32,
                ComposableTraitsXcmAssetsXcmAssetLocation,
                Option<u128>
            ]>;
            ...
            updateAsset: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, location: ComposableTraitsXcmAssetsXcmAssetLocation | {
                parents?: any;
                interior?: any;
            } | string | Uint8Array, ratio: Option<u128> | null | object | string | Uint8Array, decimals: Option<u32> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u128,
                ComposableTraitsXcmAssetsXcmAssetLocation,
                Option<u128>,
                Option<u32>
        ...
        council: {
             ...
             * # </weight>
             **/
            setMembers: AugmentedSubmittable<(newMembers: Vec<AccountId32> | (AccountId32 | string | Uint8Array)[], prime: Option<AccountId32> | null | object | string | Uint8Array, oldCount: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                Vec<AccountId32>,
                Option<AccountId32>,
                u32
            ]>;
        ...
        democracy: {
             ...
             * reasonable value).
             **/
            blacklist: AugmentedSubmittable<(proposalHash: H256 | string | Uint8Array, maybeRefIndex: Option<u32> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                H256,
                Option<u32>
            ]>;
            /**
        ...
        dexRouter: {
            ...
            addLiquidity: AugmentedSubmittable<(assetPair: ComposableTraitsDefiCurrencyPairCurrencyId | {
                base?: any;
                quote?: any;
            } | string | Uint8Array, baseAmount: u128 | AnyNumber | Uint8Array, quoteAmount: u128 | AnyNumber | Uint8Array, minMintAmount: u128 | AnyNumber | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
            ...
            buy: AugmentedSubmittable<(assetPair: ComposableTraitsDefiCurrencyPairCurrencyId | {
                base?: any;
                quote?: any;
            } | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, minReceive: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                ComposableTraitsDefiCurrencyPairCurrencyId,
                u128,
                u128
            ]>;
            ...
            removeLiquidity: AugmentedSubmittable<(assetPair: ComposableTraitsDefiCurrencyPairCurrencyId | {
                base?: any;
                quote?: any;
            } | string | Uint8Array, lpAmount: u128 | AnyNumber | Uint8Array, minBaseAmount: u128 | AnyNumber | Uint8Array, minQuoteAmount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                ComposableTraitsDefiCurrencyPairCurrencyId,
                u128,
                u128,
                u128
            ...
            updateRoute: AugmentedSubmittable<(assetPair: ComposableTraitsDefiCurrencyPairCurrencyId | {
                base?: any;
                quote?: any;
            } | string | Uint8Array, route: Option<Vec<u128>> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                ComposableTraitsDefiCurrencyPairCurrencyId,
                Option<Vec<u128>>
            ]>;
            /**
        ...
        lending: {
             ...
             **/
            depositCollateral: AugmentedSubmittable<(marketId: u32 | AnyNumber | Uint8Array, amount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u32,
                u128
            ]>;
            /**
        ...
        mosaic: {
             ...
             * an error.
             **/
            transferTo: AugmentedSubmittable<(networkId: u32 | AnyNumber | Uint8Array, assetId: u128 | AnyNumber | Uint8Array, address: ComposableSupportEthereumAddress | string | Uint8Array, amount: u128 | AnyNumber | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u32,
                u128,
             ...
             * - `AssetMappingUpdated`
             **/
            updateAssetMapping: AugmentedSubmittable<(assetId: u128 | AnyNumber | Uint8Array, networkId: u32 | AnyNumber | Uint8Array, remoteAssetId: Option<CommonMosaicRemoteAssetId> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u128,
                u32,
        ...
        pablo: {
             ...
             **/
            addLiquidity: AugmentedSubmittable<(poolId: u128 | AnyNumber | Uint8Array, baseAmount: u128 | AnyNumber | Uint8Array, quoteAmount: u128 | AnyNumber | Uint8Array, minMintAmount: u128 | AnyNumber | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u128,
                u128,
                u128,
                u128,
             ...
             **/
            buy: AugmentedSubmittable<(poolId: u128 | AnyNumber | Uint8Array, assetId: u128 | AnyNumber | Uint8Array, amount: u128 | AnyNumber | Uint8Array, minReceive: u128 | AnyNumber | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u128,
                u128,
                u128,
                u128,
             ...
             **/
            removeLiquidity: AugmentedSubmittable<(poolId: u128 | AnyNumber | Uint8Array, lpAmount: u128 | AnyNumber | Uint8Array, minBaseAmount: u128 | AnyNumber | Uint8Array, minQuoteAmount: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u128,
                u128,
                u128,
                u128
             ...
             * Emits `Swapped` event when successful.
             **/
            sell: AugmentedSubmittable<(poolId: u128 | AnyNumber | Uint8Array, assetId: u128 | AnyNumber | Uint8Array, amount: u128 | AnyNumber | Uint8Array, minReceive: u128 | AnyNumber | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u128,
                u128,
                u128,
                u128,
            ...
            swap: AugmentedSubmittable<(poolId: u128 | AnyNumber | Uint8Array, pair: ComposableTraitsDefiCurrencyPairCurrencyId | {
                base?: any;
                quote?: any;
            } | string | Uint8Array, quoteAmount: u128 | AnyNumber | Uint8Array, minReceive: u128 | AnyNumber | Uint8Array, keepAlive: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u128,
                ComposableTraitsDefiCurrencyPairCurrencyId,
                u128,
                u128,
        ...
        relayerXcm: {
             ...
             **/
            forceDefaultXcmVersion: AugmentedSubmittable<(maybeXcmVersion: Option<u32> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                Option<u32>
            ]>;
            /**
        ...
        sudo: {
            ...
            sudoUncheckedWeight: AugmentedSubmittable<(call: Call | {
                callIndex?: any;
                args?: any;
            } | string | Uint8Array, weight: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                Call,
                u64
            ]>;
            /**
        ...
        vault: {
             ...
             **/
            claimSurcharge: AugmentedSubmittable<(dest: u64 | AnyNumber | Uint8Array, address: Option<AccountId32> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u64,
                Option<AccountId32>
            ]>;
            /**
            ...
            deleteTombstoned: AugmentedSubmittable<(dest: u64 | AnyNumber | Uint8Array, address: Option<AccountId32> | null | object | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                u64,
                Option<AccountId32>
            ]>;
            /**
        ...
        vesting: {
            ...
            claimFor: AugmentedSubmittable<(dest: MultiAddress | {
                ...
                Address20: any;
            } | string | Uint8Array, asset: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [
                MultiAddress,
                u128
            ]>;
