import { FeaturedBox, FeaturedBoxProps } from "../../../../apps/pablo/components";
...
const Template: Story<typeof FeaturedBoxStories> = (args) => (
  <FeaturedBoxStories {...defaultArgs} {...args} />
);
...
// Title Props Featured Box
export const TitlePropsFeaturedBox = Template.bind({});
TitlePropsFeaturedBox.args = {
  textAbove: "APY",
  title: "2,624%",
