...
import type { ComposableTraitsXcmCumulusMethodId } from "@/defi/polkadot/interfaces/common";
import type {
...
declare module "@polkadot/api-base/types/storage" {
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    assetsRegistry: {
       ...
       **/
      assetRatio: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<u128>>, [u128]> &
      ...
      foreignToLocal: AugmentedQuery<
        ApiType,
        (
          arg: ComposableTraitsXcmAssetsXcmAssetLocation | { parents?: any; interior?: any } | string | Uint8Array
      ...
      localToForeign: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<ComposableTraitsXcmAssetsForeignMetadata>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      minFeeAmounts: AugmentedQuery<
        ...
        (
          ...
          arg2: ComposableTraitsXcmAssetsXcmAssetLocation | { parents?: any; interior?: any } | string | Uint8Array
        ) => Observable<Option<u128>>,
    ...
    bondedFinance: {
      ...
      bondOffers: AugmentedQuery<
        ...
        ) => Observable<Option<ITuple<[AccountId32, ComposableTraitsBondedFinanceBondOffer]>>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
    ...
    crowdloanRewards: {
      ...
      associations: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletCrowdloanRewardsModelsRemoteAccount>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
      ...
      rewards: AugmentedQuery<
        ApiType,
        (
          arg: PalletCrowdloanRewardsModelsRemoteAccount | { RelayChain: any } | { Ethereum: any } | string | Uint8Array
    ...
    currencyFactory: {
      assetEd: AugmentedQuery<ApiType, (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<u128>>, [u128]> &
        QueryableStorageEntry<ApiType, [u128]>;
      assetIdRanges: AugmentedQuery<ApiType, () => Observable<PalletCurrencyFactoryRanges>, []> &
        QueryableStorageEntry<ApiType, []>;
      assetMetadata: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<ComposableTraitsAssetsBasicAssetMetadata>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
    ...
    dutchAuction: {
      ...
      configurations: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<ComposableTraitsTimeTimeReleaseFunction>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
      ...
      localOrderIdToRemote: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<ITuple<[u32, u64]>>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      ...
      parachainXcmCallbackLocation: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<ComposableTraitsXcmCumulusMethodId>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      sellOrders: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletDutchAuctionSellOrder>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
      ...
      takes: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<Vec<PalletDutchAuctionTakeOrder>>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      xcmSellOrders: AugmentedQuery<
        ApiType,
        (arg1: u32 | AnyNumber | Uint8Array, arg2: u64 | AnyNumber | Uint8Array) => Observable<Option<u128>>,
        [u32, u64]
      > &
    ...
    governanceRegistry: {
      originsByAssetId: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<ComposableTraitsGovernanceSignedRawOrigin>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
    ...
    lending: {
       ...
       * market borrow index
       **/
      borrowIndex: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<u128>>, [u32]> &
        QueryableStorageEntry<ApiType, [u32]>;
      ...
      markets: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<ComposableTraitsLendingMarketConfig>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    liquidations: {
      ...
      strategies: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletLiquidationsLiquidationStrategyConfiguration>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
    ...
    mosaic: {
      assetsInfo: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletMosaicAssetInfo>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
      ...
      networkInfos: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletMosaicNetworkInfo>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      ...
      remoteToLocalAsset: AugmentedQuery<
        ApiType,
        (
          arg1: CommonMosaicRemoteAssetId | { EthereumTokenAddress: any } | string | Uint8Array,
          arg2: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<u128>>,
    ...
    oracle: {
      ...
      assetsInfo: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletOracleAssetInfo>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
      ...
      declaredWithdraws: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletOracleWithdraw>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
      ...
      prePrices: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Vec<PalletOraclePrePrice>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
      ...
      priceHistory: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Vec<ComposableTraitsOraclePrice>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
      ...
      prices: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<ComposableTraitsOraclePrice>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
    ...
    pablo: {
      ...
      pools: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletPabloPoolConfiguration>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      priceCumulativeState: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletPabloPriceCumulative>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      twapState: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletPabloTimeWeightedAveragePrice>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
    ...
    session: {
      ...
      nextKeys: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<Option<DaliRuntimeOpaqueSessionKeys>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
      ...
      queuedKeys: AugmentedQuery<
        ApiType,
        () => Observable<Vec<ITuple<[AccountId32, DaliRuntimeOpaqueSessionKeys]>>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      /**
    ...
    unknownTokens: {
      ...
      abstractFungibleBalances: AugmentedQuery<
        ApiType,
        (
          arg1: XcmV1MultiLocation | { parents?: any; interior?: any } | string | Uint8Array,
      ...
      concreteFungibleBalances: AugmentedQuery<
        ...
        (
          arg1: XcmV1MultiLocation | { parents?: any; interior?: any } | string | Uint8Array,
          arg2: XcmV1MultiLocation | { parents?: any; interior?: any } | string | Uint8Array
        ) => Observable<u128>,
    ...
    vault: {
      ...
      vaults: AugmentedQuery<
        ApiType,
        (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<PalletVaultModelsVaultInfo>>,
        [u64]
      > &
        QueryableStorageEntry<ApiType, [u64]>;
      /**
    ...
    vesting: {
      ...
      vestingSchedules: AugmentedQuery<
        ...
        (
          arg1: AccountId32 | string | Uint8Array,
          arg2: u128 | AnyNumber | Uint8Array
        ) => Observable<Vec<ComposableTraitsVestingVestingSchedule>>,
        [AccountId32, u128]
      > &
        QueryableStorageEntry<ApiType, [AccountId32, u128]>;
      /**
