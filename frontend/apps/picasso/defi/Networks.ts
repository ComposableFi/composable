...
export const NETWORKS: {
  ...
  1: {
    ...
    infoPage: "Etherscan",
    logo: getImageURL(("/networks/mainnet.svg")),
  ...
  42161: {
    ...
    infoPage: "Arbiscan",
    logo: getImageURL("/networks/arbitrum.svg"),
  ...
  137: {
    ...
    logo: getImageURL("/networks/polygon.svg"),
  ...
  43114: {
    ...
    infoPage: "Avax Scan",
    logo: getImageURL("/networks/avalanche.svg"),
  ...
  1285: {
    ...
    logo: getImageURL("/networks/moonriver.svg"),
  ...
  250: {
    ...
    logo: getImageURL("/networks/fantom.svg"),
