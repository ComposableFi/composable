module.exports = class Init1658297934226 {
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "vesting_schedule" ("id" character varying NOT NULL, "event_id" text NOT NULL, "from" text NOT NULL, "schedule_id" text NOT NULL, "beneficiary" text NOT NULL, "schedule" jsonb NOT NULL, CONSTRAINT "PK_4818b05532ed9058110ed5b5b13" PRIMARY KEY ("id"))`)
