module.exports = class Init1660205708877 {
  name = 'Init1660205708877'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "picasso_transaction" ("id" character varying NOT NULL, "event_id" text NOT NULL, "transaction_id" text NOT NULL, "transaction_type" character varying(37) NOT NULL, "block_number" numeric NOT NULL, "fee" numeric NOT NULL, "timestamp" numeric NOT NULL, "who_id" character varying NOT NULL, CONSTRAINT "PK_084881080801746da05dec9ce3b" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_4db5d36566d48e77e524ba938f" ON "picasso_transaction" ("who_id") `)
    await db.query(`CREATE TABLE "picasso_account" ("id" character varying NOT NULL, "event_id" text NOT NULL, "transaction_id" text NOT NULL, "balance" numeric NOT NULL, CONSTRAINT "PK_4dd97351df1d9d82880265f9ed5" PRIMARY KEY ("id"))`)
    ...
    await db.query(`ALTER TABLE "picasso_transaction" ADD CONSTRAINT "FK_4db5d36566d48e77e524ba938f5" FOREIGN KEY ("who_id") REFERENCES "picasso_account"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  }
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_4db5d36566d48e77e524ba938f"`)
    await db.query(`DROP TABLE "picasso_account"`)
    ...
    await db.query(`ALTER TABLE "picasso_transaction" DROP CONSTRAINT "FK_4db5d36566d48e77e524ba938f5"`)
  }
}
