module.exports = class Data1675961436631 {
    name = 'Data1675961436631'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "historical_asset_price" ("id" character varying NOT NULL, "event_id" text NOT NULL, "price" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "currency" character varying(3) NOT NULL, "block_id" text NOT NULL, "asset_id" character varying, CONSTRAINT "PK_01a6bc75d8046fb5aa80df3b9fe" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "asset" ("id" character varying NOT NULL, "event_id" text NOT NULL, "price" numeric NOT NULL, "decimals" integer, "block_id" text NOT NULL, CONSTRAINT "PK_1209d107fe21482beaea51b745e" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_3d0534c2bb8faaf00628625ad2" ON "asset" ("event_id") `)
        await db.query(`CREATE TABLE "staking_position" ("id" character varying NOT NULL, "fnft_collection_id" text NOT NULL, "fnft_instance_id" text NOT NULL, "owner" text NOT NULL, "asset_id" text NOT NULL, "amount" numeric NOT NULL, "start_timestamp" numeric NOT NULL, "duration" numeric NOT NULL, "end_timestamp" numeric, "reward_multiplier" numeric NOT NULL, "source" character varying(16) NOT NULL, "removed" boolean NOT NULL, "reward_pool_id" character varying, "event_id" character varying NOT NULL, CONSTRAINT "REL_3e2e1b465d89dbb2736e70fe5f" UNIQUE ("event_id"), CONSTRAINT "PK_899113a8f0b5ec707171ff4db6b" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_c9125c51780c020c954de839a7" ON "staking_position" ("reward_pool_id") `)
        ...
        await db.query(`CREATE TABLE "reward" ("id" character varying NOT NULL, "reward_rate_period" character varying(10) NOT NULL, "reward_rate_amount" numeric NOT NULL, "reward_pool_id" character varying, CONSTRAINT "PK_a90ea606c229e380fb341838036" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_a5907a59946e89972b394251f5" ON "reward" ("reward_pool_id") `)
        await db.query(`CREATE TABLE "reward_pool" ("id" character varying NOT NULL, "asset_id" text NOT NULL, "block_id" text NOT NULL, "event_id" character varying NOT NULL, CONSTRAINT "REL_863db0d97cf58a3f045eddaca4" UNIQUE ("event_id"), CONSTRAINT "PK_c88dfa6b514dcbadb05c6956afb" PRIMARY KEY ("id"))`)
        await db.query(`CREATE UNIQUE INDEX "IDX_863db0d97cf58a3f045eddaca4" ON "reward_pool" ("event_id") `)
        await db.query(`CREATE INDEX "IDX_07af66f70998464bb28098b556" ON "reward_pool" ("asset_id") `)
        ...
        await db.query(`ALTER TABLE "staking_position" ADD CONSTRAINT "FK_c9125c51780c020c954de839a72" FOREIGN KEY ("reward_pool_id") REFERENCES "reward_pool"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        ...
        await db.query(`ALTER TABLE "reward" ADD CONSTRAINT "FK_a5907a59946e89972b394251f5b" FOREIGN KEY ("reward_pool_id") REFERENCES "reward_pool"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "reward_pool" ADD CONSTRAINT "FK_863db0d97cf58a3f045eddaca45" FOREIGN KEY ("event_id") REFERENCES "event"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_c9125c51780c020c954de839a7"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_a5907a59946e89972b394251f5"`)
        await db.query(`DROP TABLE "reward_pool"`)
        await db.query(`DROP INDEX "public"."IDX_863db0d97cf58a3f045eddaca4"`)
        await db.query(`DROP INDEX "public"."IDX_07af66f70998464bb28098b556"`)
        ...
        await db.query(`ALTER TABLE "staking_position" DROP CONSTRAINT "FK_c9125c51780c020c954de839a72"`)
        await db.query(`ALTER TABLE "staking_position" DROP CONSTRAINT "FK_3e2e1b465d89dbb2736e70fe5f1"`)
        await db.query(`ALTER TABLE "reward" DROP CONSTRAINT "FK_a5907a59946e89972b394251f5b"`)
        await db.query(`ALTER TABLE "reward_pool" DROP CONSTRAINT "FK_863db0d97cf58a3f045eddaca45"`)
