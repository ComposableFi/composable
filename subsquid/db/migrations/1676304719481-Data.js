module.exports = class Data1676304719481 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "pablo_lp_token" ("id" character varying NOT NULL, "total_issued" numeric NOT NULL, "pool_id" text NOT NULL, "block_id" text NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, CONSTRAINT "PK_895ee239c4061a1cf17158b641f" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_d8f4ca6e8c072a454bedc53cdb" ON "pablo_lp_token" ("pool_id") `)
        await db.query(`CREATE INDEX "IDX_df7e6bd2dfeac916c9444f6635" ON "pablo_lp_token" ("timestamp") `)
        ...
        await db.query(`CREATE TABLE "pablo_pool" ("id" character varying NOT NULL, "event_id" text NOT NULL, "owner" text NOT NULL, "pool_type" character varying(24) NOT NULL, "transaction_count" integer NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_id" text NOT NULL, "quote_asset_id" text NOT NULL, "lp_token_id" character varying, CONSTRAINT "PK_28d674c3fdadf69d19745e5343a" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_76686140a45d0a11fadadc16f6" ON "pablo_pool" ("owner") `)
        await db.query(`CREATE INDEX "IDX_146c38df24beeb118101de89db" ON "pablo_pool" ("lp_token_id") `)
        ...
        await db.query(`CREATE TABLE "staking_rewards_pool" ("id" character varying NOT NULL, "event_id" text NOT NULL, "pool_id" text NOT NULL, "block_id" text NOT NULL, "owner" text NOT NULL, "asset_id" text NOT NULL, "share_asset_id" text NOT NULL, "financial_nft_asset_id" text NOT NULL, "minimum_staking_amount" numeric NOT NULL, "start_block" integer NOT NULL, "reward_rate_period" character varying(9) NOT NULL, "reward_rate_amount" numeric NOT NULL, CONSTRAINT "PK_2a6dffa400cfd2b4f1d41875f8b" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_ddfc09a014c555b2046ffffbe3" ON "staking_rewards_pool" ("event_id") `)
        await db.query(`CREATE INDEX "IDX_3e509eb21680c4ed7f33c2ff6d" ON "staking_rewards_pool" ("pool_id") `)
        await db.query(`CREATE INDEX "IDX_9f1e150c0ccf020976fd19b8bb" ON "staking_rewards_pool" ("owner") `)
        await db.query(`CREATE INDEX "IDX_644190450406b203b36b3a3d1e" ON "staking_rewards_pool" ("asset_id") `)
        await db.query(`CREATE INDEX "IDX_6d74dfd2af6669c7aabf1d31a0" ON "staking_rewards_pool" ("share_asset_id") `)
        await db.query(`CREATE INDEX "IDX_5a8d76c909b617d18bf2b4e72d" ON "staking_rewards_pool" ("financial_nft_asset_id") `)
        ...
        await db.query(`CREATE TABLE "historical_pablo_fee_apr" ("id" character varying NOT NULL, "trading_fee" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_id" text NOT NULL, "event_id" character varying, "pool_id" character varying, CONSTRAINT "PK_fd18e73c807da91752aa9429e88" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_0f00310f3236eb8356b77f6744" ON "historical_pablo_fee_apr" ("event_id") `)
        await db.query(`CREATE INDEX "IDX_54ab2723146556db322aa1a6d8" ON "historical_pablo_fee_apr" ("pool_id") `)
        await db.query(`CREATE INDEX "IDX_9854db0dba96ceef6d4e522820" ON "historical_pablo_fee_apr" ("timestamp") `)
        await db.query(`CREATE TABLE "historical_staking_apr" ("id" character varying NOT NULL, "asset_id" text NOT NULL, "staking_apr" numeric NOT NULL, "timestamp" TIMESTAMP WITH TIME ZONE NOT NULL, "block_id" text NOT NULL, "event_id" character varying, CONSTRAINT "PK_34138172ca2fdf57d4f5d8c052c" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_691736d35dad2ab5c910d30a7c" ON "historical_staking_apr" ("event_id") `)
        await db.query(`CREATE INDEX "IDX_55af441c9e176bab91d0090514" ON "historical_staking_apr" ("asset_id") `)
        await db.query(`CREATE INDEX "IDX_379141d2992d22078cf0e68223" ON "historical_staking_apr" ("timestamp") `)
        ...
        await db.query(`ALTER TABLE "pablo_pool" ADD CONSTRAINT "FK_146c38df24beeb118101de89db3" FOREIGN KEY ("lp_token_id") REFERENCES "pablo_lp_token"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        ...
        await db.query(`ALTER TABLE "pablo_liquidity_added" ADD CONSTRAINT "FK_bafde96a7f97a136193c5aac2e1" FOREIGN KEY ("event_id") REFERENCES "event"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "pablo_liquidity_added" ADD CONSTRAINT "FK_a057af366fd184a7c71fd19e348" FOREIGN KEY ("pool_id") REFERENCES "pablo_pool"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "pablo_liquidity_removed" ADD CONSTRAINT "FK_99cd30a53612c12da96ba255f96" FOREIGN KEY ("event_id") REFERENCES "event"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "pablo_liquidity_removed" ADD CONSTRAINT "FK_cc8c8c14f2ee44a3c73e18fd9b3" FOREIGN KEY ("pool_id") REFERENCES "pablo_pool"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        ...
        await db.query(`ALTER TABLE "historical_pablo_fee_apr" ADD CONSTRAINT "FK_0f00310f3236eb8356b77f6744f" FOREIGN KEY ("event_id") REFERENCES "event"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "historical_pablo_fee_apr" ADD CONSTRAINT "FK_54ab2723146556db322aa1a6d84" FOREIGN KEY ("pool_id") REFERENCES "pablo_pool"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
        await db.query(`ALTER TABLE "historical_staking_apr" ADD CONSTRAINT "FK_691736d35dad2ab5c910d30a7ce" FOREIGN KEY ("event_id") REFERENCES "event"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    async down(db) {
        ...
        await db.query(`DROP TABLE "pablo_lp_token"`)
        await db.query(`DROP INDEX "public"."IDX_d8f4ca6e8c072a454bedc53cdb"`)
        await db.query(`DROP INDEX "public"."IDX_df7e6bd2dfeac916c9444f6635"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_146c38df24beeb118101de89db"`)
        ...
        await db.query(`DROP TABLE "staking_rewards_pool"`)
        await db.query(`DROP INDEX "public"."IDX_ddfc09a014c555b2046ffffbe3"`)
        await db.query(`DROP INDEX "public"."IDX_3e509eb21680c4ed7f33c2ff6d"`)
        await db.query(`DROP INDEX "public"."IDX_9f1e150c0ccf020976fd19b8bb"`)
        await db.query(`DROP INDEX "public"."IDX_644190450406b203b36b3a3d1e"`)
        await db.query(`DROP INDEX "public"."IDX_6d74dfd2af6669c7aabf1d31a0"`)
        await db.query(`DROP INDEX "public"."IDX_5a8d76c909b617d18bf2b4e72d"`)
        ...
        await db.query(`DROP TABLE "historical_pablo_fee_apr"`)
        await db.query(`DROP INDEX "public"."IDX_0f00310f3236eb8356b77f6744"`)
        await db.query(`DROP INDEX "public"."IDX_54ab2723146556db322aa1a6d8"`)
        await db.query(`DROP INDEX "public"."IDX_9854db0dba96ceef6d4e522820"`)
        await db.query(`DROP TABLE "historical_staking_apr"`)
        await db.query(`DROP INDEX "public"."IDX_691736d35dad2ab5c910d30a7c"`)
        await db.query(`DROP INDEX "public"."IDX_55af441c9e176bab91d0090514"`)
        await db.query(`DROP INDEX "public"."IDX_379141d2992d22078cf0e68223"`)
        ...
        await db.query(`ALTER TABLE "pablo_pool" DROP CONSTRAINT "FK_146c38df24beeb118101de89db3"`)
        ...
        await db.query(`ALTER TABLE "historical_pablo_fee_apr" DROP CONSTRAINT "FK_0f00310f3236eb8356b77f6744f"`)
        await db.query(`ALTER TABLE "historical_pablo_fee_apr" DROP CONSTRAINT "FK_54ab2723146556db322aa1a6d84"`)
        await db.query(`ALTER TABLE "historical_staking_apr" DROP CONSTRAINT "FK_691736d35dad2ab5c910d30a7ce"`)
