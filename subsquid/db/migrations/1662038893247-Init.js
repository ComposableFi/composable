module.exports = class Init1662038893247 {
  name = 'Init1662038893247'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "pablo_transaction" ("id" character varying NOT NULL, "base_asset_id" numeric NOT NULL, "base_asset_amount" numeric NOT NULL, "quote_asset_id" numeric NOT NULL, "quote_asset_amount" numeric NOT NULL, "spot_price" text NOT NULL, "fee" text NOT NULL, "pool_id" character varying NOT NULL, CONSTRAINT "PK_8b040ecc6da14a71ef547ae2ae6" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "pablo_transaction_old" ("id" character varying NOT NULL, "event_id" text NOT NULL, "who" text NOT NULL, "transaction_type" character varying(16), "base_asset_id" numeric NOT NULL, "base_asset_amount" numeric NOT NULL, "quote_asset_id" numeric NOT NULL, "quote_asset_amount" numeric NOT NULL, "block_number" numeric NOT NULL, "spot_price" text NOT NULL, "fee" text NOT NULL, "received_timestamp" numeric NOT NULL, "pool_id" character varying NOT NULL, CONSTRAINT "PK_becb007433c9dbe82ef51900ee5" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_58d143b6e1e020caa19a2fbd0f" ON "pablo_transaction_old" ("pool_id") `)
    ...
    await db.query(`ALTER TABLE "pablo_transaction_old" ADD CONSTRAINT "FK_58d143b6e1e020caa19a2fbd0f3" FOREIGN KEY ("pool_id") REFERENCES "pablo_pool"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await db.query(`ALTER TABLE "transaction" ADD CONSTRAINT "FK_9b5e57206d054abff1916ec791e" FOREIGN KEY ("pablo_transaction_id") REFERENCES "pablo_transaction"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  }
  ...
  async down(db) {
    ...
    await db.query(`DROP TABLE "pablo_transaction_old"`)
    await db.query(`DROP INDEX "public"."IDX_58d143b6e1e020caa19a2fbd0f"`)
    ...
    await db.query(`ALTER TABLE "pablo_transaction_old" DROP CONSTRAINT "FK_58d143b6e1e020caa19a2fbd0f3"`)
    await db.query(`ALTER TABLE "historical_asset_price" DROP CONSTRAINT "FK_e5b6c7a8a991d63c9670391daaf"`)
    await db.query(`ALTER TABLE "transaction" DROP CONSTRAINT "FK_9b5e57206d054abff1916ec791e"`)
  }
}
