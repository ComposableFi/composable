module.exports = class Init1657701150334 {
  name = 'Init1657701150334'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "vesting_schedule" ("id" character varying NOT NULL, "beneficiary" text NOT NULL, "schedule" jsonb NOT NULL, CONSTRAINT "PK_4818b05532ed9058110ed5b5b13" PRIMARY KEY ("id"))`)
