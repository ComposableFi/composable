module.exports = class Init1662554182639 {
  name = 'Init1662554182639'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "activity" ("id" character varying NOT NULL, "account_id" text NOT NULL, "timestamp" numeric NOT NULL, "event_id_id" character varying NOT NULL, CONSTRAINT "PK_24625a1d6b1b089c8ae206fe467" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_b78f646c16cb1816097e3a3086" ON "activity" ("event_id_id") `)
    await db.query(`CREATE INDEX "IDX_96c7c848eec1feba0bc66b4519" ON "activity" ("account_id") `)
    await db.query(`CREATE TABLE "event" ("id" character varying NOT NULL, "account_id" text NOT NULL, "event_type" character varying(43) NOT NULL, "block_number" numeric NOT NULL, "timestamp" numeric NOT NULL, CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`)
    ...
    await db.query(`CREATE TABLE "pablo_transaction" ("id" character varying NOT NULL, "base_asset_id" text NOT NULL, "base_asset_amount" numeric NOT NULL, "quote_asset_id" text NOT NULL, "quote_asset_amount" numeric NOT NULL, "spot_price" text NOT NULL, "fee" text NOT NULL, "event_id_id" character varying NOT NULL, "pool_id" character varying NOT NULL, CONSTRAINT "REL_c7287c799cd4451929736d89ac" UNIQUE ("event_id_id"), CONSTRAINT "PK_8b040ecc6da14a71ef547ae2ae6" PRIMARY KEY ("id"))`)
    await db.query(`CREATE UNIQUE INDEX "IDX_c7287c799cd4451929736d89ac" ON "pablo_transaction" ("event_id_id") `)
    ...
    await db.query(`CREATE TABLE "staking_position" ("id" character varying NOT NULL, "position_id" text NOT NULL, "owner" text NOT NULL, "asset_id" text NOT NULL, "amount" numeric NOT NULL, "start_timestamp" numeric NOT NULL, "end_timestamp" numeric, "source" character varying(14) NOT NULL, "event_id_id" character varying NOT NULL, CONSTRAINT "REL_bfed2a33f0bee42638df0968e0" UNIQUE ("event_id_id"), CONSTRAINT "PK_899113a8f0b5ec707171ff4db6b" PRIMARY KEY ("id"))`)
    await db.query(`CREATE UNIQUE INDEX "IDX_bfed2a33f0bee42638df0968e0" ON "staking_position" ("event_id_id") `)
    await db.query(`CREATE INDEX "IDX_dcfb262a7bc62ef624f1c03a82" ON "staking_position" ("position_id") `)
    await db.query(`CREATE INDEX "IDX_e94373a6b771b4edcaca7950bc" ON "staking_position" ("owner") `)
    await db.query(`CREATE TABLE "historical_locked_value" ("id" character varying NOT NULL, "amount" numeric NOT NULL, "currency" character varying(3) NOT NULL, "timestamp" numeric NOT NULL, "event_id_id" character varying NOT NULL, CONSTRAINT "REL_3ea0cd3bd3df977a4e8e5a8b63" UNIQUE ("event_id_id"), CONSTRAINT "PK_39755ccbc61547e8b814bf28188" PRIMARY KEY ("id"))`)
    await db.query(`CREATE UNIQUE INDEX "IDX_3ea0cd3bd3df977a4e8e5a8b63" ON "historical_locked_value" ("event_id_id") `)
    ...
    await db.query(`ALTER TABLE "activity" ADD CONSTRAINT "FK_b78f646c16cb1816097e3a3086c" FOREIGN KEY ("event_id_id") REFERENCES "event"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "pablo_transaction" ADD CONSTRAINT "FK_c7287c799cd4451929736d89aca" FOREIGN KEY ("event_id_id") REFERENCES "event"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    ...
    await db.query(`ALTER TABLE "staking_position" ADD CONSTRAINT "FK_bfed2a33f0bee42638df0968e0c" FOREIGN KEY ("event_id_id") REFERENCES "event"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "historical_locked_value" ADD CONSTRAINT "FK_3ea0cd3bd3df977a4e8e5a8b634" FOREIGN KEY ("event_id_id") REFERENCES "event"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  }
  ...
  async down(db) {
    ...
    await db.query(`DROP INDEX "public"."IDX_b78f646c16cb1816097e3a3086"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_c7287c799cd4451929736d89ac"`)
    ...
    await db.query(`DROP INDEX "public"."IDX_bfed2a33f0bee42638df0968e0"`)
    await db.query(`DROP INDEX "public"."IDX_dcfb262a7bc62ef624f1c03a82"`)
    await db.query(`DROP INDEX "public"."IDX_e94373a6b771b4edcaca7950bc"`)
    await db.query(`DROP TABLE "historical_locked_value"`)
    await db.query(`DROP INDEX "public"."IDX_3ea0cd3bd3df977a4e8e5a8b63"`)
    await db.query(`ALTER TABLE "pablo_pool_asset" DROP CONSTRAINT "FK_7fd4cdb45620476d1de745a2658"`)
    await db.query(`ALTER TABLE "activity" DROP CONSTRAINT "FK_b78f646c16cb1816097e3a3086c"`)
    await db.query(`ALTER TABLE "pablo_transaction" DROP CONSTRAINT "FK_c7287c799cd4451929736d89aca"`)
    ...
    await db.query(`ALTER TABLE "staking_position" DROP CONSTRAINT "FK_bfed2a33f0bee42638df0968e0c"`)
    await db.query(`ALTER TABLE "historical_locked_value" DROP CONSTRAINT "FK_3ea0cd3bd3df977a4e8e5a8b634"`)
  }
}
