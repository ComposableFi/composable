module.exports = class Init1657889647593 {
  name = 'Init1657889647593'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "vesting_schedule" ("id" character varying NOT NULL, "event_id" text NOT NULL, "schedule_id" text NOT NULL, "beneficiary" text NOT NULL, "schedule" jsonb NOT NULL, CONSTRAINT "PK_4818b05532ed9058110ed5b5b13" PRIMARY KEY ("id"))`)
