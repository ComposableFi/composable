...
processor.addEventHandler("StakingRewards.RewardPoolCreated", processRewardPoolCreatedEvent);

processor.addEventHandler("StakingRewards.Staked", processStakedEvent);

processor.addEventHandler("StakingRewards.StakeAmountExtended", processStakeAmountExtendedEvent);

processor.addEventHandler("StakingRewards.Unstaked", processUnstakedEvent);

processor.addEventHandler("StakingRewards.SplitPosition", processSplitPositionEvent);

processor.addEventHandler("StakingRewards.RewardPoolUpdated", processRewardPoolUpdatedEvent);
