  ...
  interface AugmentedEvents<ApiType extends ApiTypes> {
    assetsRegistry: {
      AssetRegistered: AugmentedEvent<
        ApiType,
        [assetId: u128, location: ComposableTraitsXcmAssetsXcmAssetLocation],
        { assetId: u128; location: ComposableTraitsXcmAssetsXcmAssetLocation }
      >;
    ...
    bondedFinance: {
       ...
       **/
      NewBond: AugmentedEvent<
        ApiType,
        [offerId: u128, who: AccountId32, nbOfBonds: u128],
        { offerId: u128; who: AccountId32; nbOfBonds: u128 }
      >;
      /**
       * A new offer has been created.
       **/
      NewOffer: AugmentedEvent<
        ApiType,
        [offerId: u128, beneficiary: AccountId32],
        { offerId: u128; beneficiary: AccountId32 }
      >;
      /**
       * An offer has been cancelled by the `AdminOrigin`.
       **/
      OfferCancelled: AugmentedEvent<
        ApiType,
        [offerId: u128],
        { offerId: u128 }
      >;
    ...
    cosmwasm: {
      ...
      >;
      ExecutionFailed: AugmentedEvent<
        ApiType,
        [
          contract: AccountId32,
          entrypoint: PalletCosmwasmEntryPoint,
      ...
      Instantiated: AugmentedEvent<
        ApiType,
        [contract: AccountId32, info: PalletCosmwasmContractInfo],
        { contract: AccountId32; info: PalletCosmwasmContractInfo }
      >;
      Uploaded: AugmentedEvent<
        ApiType,
        [codeHash: H256, codeId: u64],
        { codeHash: H256; codeId: u64 }
      >;
      /**
       * Generic event
    ...
    dexRouter: {
      RouteAdded: AugmentedEvent<
        ApiType,
        [xAssetId: u128, yAssetId: u128, route: Vec<u128>],
        { xAssetId: u128; yAssetId: u128; route: Vec<u128> }
      >;
      RouteDeleted: AugmentedEvent<
        ApiType,
        [xAssetId: u128, yAssetId: u128, route: Vec<u128>],
        { xAssetId: u128; yAssetId: u128; route: Vec<u128> }
      >;
      RouteUpdated: AugmentedEvent<
        ApiType,
        [
          xAssetId: u128,
          yAssetId: u128,
    ...
    dutchAuction: {
      ConfigurationAdded: AugmentedEvent<
        ApiType,
        [
      ...
      >;
      OrderAdded: AugmentedEvent<
        ApiType,
        [orderId: u128, order: PalletDutchAuctionSellOrder],
        { orderId: u128; order: PalletDutchAuctionSellOrder }
      >;
    ...
    fnft: {
      FinancialNftBurned: AugmentedEvent<
        ApiType,
        [collectionId: u128, instanceId: u64],
        { collectionId: u128; instanceId: u64 }
      >;
      FinancialNftCollectionCreated: AugmentedEvent<
        ApiType,
        [collectionId: u128, who: AccountId32, admin: AccountId32],
        { collectionId: u128; who: AccountId32; admin: AccountId32 }
      >;
      FinancialNftCreated: AugmentedEvent<
        ApiType,
        [collectionId: u128, instanceId: u64],
        { collectionId: u128; instanceId: u64 }
      >;
      FinancialNftTransferred: AugmentedEvent<
        ApiType,
        [collectionId: u128, instanceId: u64, to: AccountId32],
        { collectionId: u128; instanceId: u64; to: AccountId32 }
      >;
      /**
       * Generic event
    ...
    governanceRegistry: {
      ...
      Set: AugmentedEvent<
        ApiType,
        [assetId: u128, value: AccountId32],
        { assetId: u128; value: AccountId32 }
      >;
      /**
       * Generic event
    ...
    ibcPing: {
       ...
       **/
      ChannelOpened: AugmentedEvent<
        ApiType,
        [channelId: Bytes, portId: Bytes],
        { channelId: Bytes; portId: Bytes }
      >;
      /**
    ...
    lending: {
       ...
       **/
      CollateralDeposited: AugmentedEvent<
        ApiType,
        [sender: AccountId32, marketId: u32, amount: u128],
        { sender: AccountId32; marketId: u32; amount: u128 }
      >;
       ...
       **/
      CollateralWithdrawn: AugmentedEvent<
        ApiType,
        [sender: AccountId32, marketId: u32, amount: u128],
        { sender: AccountId32; marketId: u32; amount: u128 }
      >;
       ...
       **/
      LiquidationInitiated: AugmentedEvent<
        ApiType,
        [marketId: u32, borrowers: Vec<AccountId32>],
        { marketId: u32; borrowers: Vec<AccountId32> }
      >;
      /**
       * Event emitted when new lending market is created.
       **/
      MarketCreated: AugmentedEvent<
        ApiType,
        [
          marketId: u32,
          vaultId: u64,
      ...
      >;
      MarketUpdated: AugmentedEvent<
        ApiType,
        [marketId: u32, input: ComposableTraitsLendingUpdateInput],
        { marketId: u32; input: ComposableTraitsLendingUpdateInput }
      >;
      /**
       * Event emitted to warn that loan may go under collateralize soon.
       **/
      MayGoUnderCollateralizedSoon: AugmentedEvent<
        ApiType,
        [marketId: u32, account: AccountId32],
        { marketId: u32; account: AccountId32 }
      >;
      /**
       * Generic event
    ...
    mosaic: {
       ...
       **/
      AssetMappingCreated: AugmentedEvent<
        ApiType,
        [
          assetId: u128,
          networkId: u32,
       ...
       **/
      AssetMappingDeleted: AugmentedEvent<
        ApiType,
        [
          assetId: u128,
          networkId: u32,
       ...
       **/
      AssetMappingUpdated: AugmentedEvent<
        ApiType,
        [
          assetId: u128,
          networkId: u32,
      ...
      NetworksUpdated: AugmentedEvent<
        ApiType,
        [networkId: u32, networkInfo: PalletMosaicNetworkInfo],
        { networkId: u32; networkInfo: PalletMosaicNetworkInfo }
      >;
      /**
      ...
      TransferIntoRescined: AugmentedEvent<
        ApiType,
        [account: AccountId32, amount: u128, assetId: u128],
        { account: AccountId32; amount: u128; assetId: u128 }
      >;
      /**
    ...
    oracle: {
       ...
       **/
      AssetInfoChange: AugmentedEvent<
        ApiType,
    ...
    pablo: {
       ...
       **/
      PoolDeleted: AugmentedEvent<
        ApiType,
        [poolId: u128, baseAmount: u128, quoteAmount: u128],
        { poolId: u128; baseAmount: u128; quoteAmount: u128 }
      >;
      /**
       * Token exchange happened.
       **/
      Swapped: AugmentedEvent<
        ApiType,
        [
          poolId: u128,
          who: AccountId32,
       ...
       * TWAP updated.
       **/
      TwapUpdated: AugmentedEvent<
        ApiType,
        [poolId: u128, timestamp: u64, twaps: BTreeMap<u128, u128>],
        { poolId: u128; timestamp: u64; twaps: BTreeMap<u128, u128> }
      >;
      /**
       * Generic event
    ...
    stakingRewards: {
      Claimed: AugmentedEvent<
        ApiType,
        [owner: AccountId32, fnftCollectionId: u128, fnftInstanceId: u64],
        { owner: AccountId32; fnftCollectionId: u128; fnftInstanceId: u64 }
      >;
      MaxRewardsAccumulated: AugmentedEvent<
        ApiType,
        [poolId: u128, assetId: u128],
        { poolId: u128; assetId: u128 }
      >;
      RewardAccumulationHookError: AugmentedEvent<
        ApiType,
        [
          poolId: u128,
          assetId: u128,
       ...
       **/
      RewardPoolCreated: AugmentedEvent<
        ApiType,
        [poolId: u128, owner: AccountId32, endBlock: u32],
        { poolId: u128; owner: AccountId32; endBlock: u32 }
      >;
      RewardPoolUpdated: AugmentedEvent<
        ApiType,
        [poolId: u128],
        { poolId: u128 }
      >;
      RewardsPotIncreased: AugmentedEvent<
        ApiType,
       ...
       **/
      RewardTransferred: AugmentedEvent<
        ApiType,
        [
          from: AccountId32,
          poolId: u128,
       ...
       **/
      SplitPosition: AugmentedEvent<
        ApiType,
        [positions: Vec<ITuple<[u128, u64, u128]>>],
        { positions: Vec<ITuple<[u128, u64, u128]>> }
      >;
      StakeAmountExtended: AugmentedEvent<
        ApiType,
        [fnftCollectionId: u128, fnftInstanceId: u64, amount: u128],
        { fnftCollectionId: u128; fnftInstanceId: u64; amount: u128 }
      >;
      Staked: AugmentedEvent<
        ApiType,
        [
          poolId: u128,
          owner: AccountId32,
      ...
      >;
      UnstakeRewardSlashed: AugmentedEvent<
        ApiType,
        [
          poolId: u128,
          owner: AccountId32,
    ...
    transfer: {
       ...
       **/
      PalletParamsUpdated: AugmentedEvent<
        ApiType,
        [sendEnabled: bool, receiveEnabled: bool],
        { sendEnabled: bool; receiveEnabled: bool }
      >;
      TokenTransferInitiated: AugmentedEvent<
        ApiType,
        [from: AccountId32, to: Bytes, amount: u128],
        { from: AccountId32; to: Bytes; amount: u128 }
      >;
      /**
       * Generic event
    ...
    vault: {
      ...
      LiquidateStrategy: AugmentedEvent<
        ApiType,
        [account: AccountId32, amount: u128],
        { account: AccountId32; amount: u128 }
      >;
      ...
      Withdrawn: AugmentedEvent<
        ApiType,
        [account: AccountId32, lpAmount: u128, assetAmount: u128],
        { account: AccountId32; lpAmount: u128; assetAmount: u128 }
      >;
      /**
       * Generic event
