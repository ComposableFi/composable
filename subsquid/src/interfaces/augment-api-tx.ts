  ...
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    assetsRegistry: {
      ...
      registerAsset: AugmentedSubmittable<
        (
          ...
          ratio: Option<u128> | null | Uint8Array | u128 | AnyNumber,
    ...
    assetTxPayment: {
      ...
      setPaymentAsset: AugmentedSubmittable<
        (
          payer: AccountId32 | string | Uint8Array,
          assetId: Option<u128> | null | Uint8Array | u128 | AnyNumber
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32, Option<u128>]
      >;
      /**
       * Generic tx
       **/
    ...
    cosmwasm: {
      ...
      execute: AugmentedSubmittable<
        (
          ...
          funds: BTreeMap<u128, ITuple<[u128, bool]>>,
          gas: u64 | AnyNumber | Uint8Array,
          message: Bytes | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [AccountId32, BTreeMap<u128, ITuple<[u128, bool]>>, u64, Bytes]
      >;
      /**
      ...
      instantiate: AugmentedSubmittable<
        (
          codeId: u64 | AnyNumber | Uint8Array,
          salt: Bytes | string | Uint8Array,
          admin: Option<AccountId32> | null | Uint8Array | AccountId32 | string,
          label: Bytes | string | Uint8Array,
          funds: BTreeMap<u128, ITuple<[u128, bool]>>,
          gas: u64 | AnyNumber | Uint8Array,
          message: Bytes | string | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
    ...
    crowdloanRewards: {
       ...
       **/
      initializeAt: AugmentedSubmittable<
        (at: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u64]
      >;
      /**
    ...
    currencyFactory: {
      addRange: AugmentedSubmittable<
        (length: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u64]
      >;
      /**
       * Sets metadata
      ...
      setMetadata: AugmentedSubmittable<
        ...
        [u128, ComposableTraitsAssetsBasicAssetMetadata]
      >;
      /**
       * Generic tx
       **/
        ...
        (
          params:
            ...
            | {
                version?: any;
                clientId?: any;
                counterpartyClientId?: any;
                commitmentPrefix?: any;
                delayPeriod?: any;
              }
            | string
            | Uint8Array
    ...
    mosaic: {
      ...
      transferTo: AugmentedSubmittable<
        (
          ...
          amount: u128 | AnyNumber | Uint8Array,
          minimumAmountOut: u128 | AnyNumber | Uint8Array,
    ...
    oracle: {
      ...
      addAssetAndInfo: AugmentedSubmittable<
        (
          ...
          rewardWeight: u128 | AnyNumber | Uint8Array,
          slash: u128 | AnyNumber | Uint8Array,
          emitPriceChanges: bool | boolean | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128, Percent, u32, u32, u32, u128, u128, bool]
      >;
      /**
      ...
      addStake: AugmentedSubmittable<
        (stake: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>,
        [u128]
      >;
      /**
       ...
       **/
      adjustRewards: AugmentedSubmittable<
        (
          annualCostPerOracle: u128 | AnyNumber | Uint8Array,
          numIdealOracles: u8 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128, u8]
      >;
      /**
       ...
       **/
      reclaimStake: AugmentedSubmittable<
        () => SubmittableExtrinsic<ApiType>,
        []
      >;
      /**
    ...
    proxy: {
      ...
      addProxy: AugmentedSubmittable<
        ...
        [AccountId32, ComposableTraitsAccountProxyProxyType, u32]
      >;
      /**
      ...
      anonymous: AugmentedSubmittable<
        ...
        [ComposableTraitsAccountProxyProxyType, u32, u16]
      >;
      /**
      ...
      proxy: AugmentedSubmittable<
        ...
        [AccountId32, Option<ComposableTraitsAccountProxyProxyType>, Call]
      >;
      /**
       * Dispatch the given `call` from an account that the sender is authorized for through
       * `add_proxy`.
    ...
    stakingRewards: {
       ...
       **/
      addToRewardsPot: AugmentedSubmittable<
        (
          poolId: u128 | AnyNumber | Uint8Array,
          assetId: u128 | AnyNumber | Uint8Array,
          amount: u128 | AnyNumber | Uint8Array,
      ...
      claim: AugmentedSubmittable<
        (
          fnftCollectionId: u128 | AnyNumber | Uint8Array,
          fnftInstanceId: u64 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128, u64]
      >;
      /**
      ...
      stake: AugmentedSubmittable<
        (
          poolId: u128 | AnyNumber | Uint8Array,
          amount: u128 | AnyNumber | Uint8Array,
          durationPreset: u64 | AnyNumber | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [u128, u128, u64]
      >;
      /**
       ...
       **/
      updateRewardsPool: AugmentedSubmittable<
        (
          poolId: u128 | AnyNumber | Uint8Array,
          rewardUpdates: BTreeMap<u128, ComposableTraitsStakingRewardUpdate>
        ) => SubmittableExtrinsic<ApiType>,
        [u128, BTreeMap<u128, ComposableTraitsStakingRewardUpdate>]
      >;
      /**
       * Generic tx
       **/
    ...
    transfer: {
      ...
      setPalletParams: AugmentedSubmittable<
        (
          params:
            | IbcTransferPalletParams
            | { sendEnabled?: any; receiveEnabled?: any }
            | string
            | Uint8Array
        ) => SubmittableExtrinsic<ApiType>,
        [IbcTransferPalletParams]
    ...
    vesting: {
      ...
      claim: AugmentedSubmittable<
        ...
        [u128, ComposableTraitsVestingVestingScheduleIdSet]
      >;
      /**
      ...
      claimFor: AugmentedSubmittable<
        ...
        [MultiAddress, u128, ComposableTraitsVestingVestingScheduleIdSet]
      >;
      /**
