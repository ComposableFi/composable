...
declare module "@polkadot/api-base/types/storage" {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    assetsRegistry: {
       ...
       **/
      localToForeign: AugmentedQuery<
        ApiType,
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<ComposableTraitsXcmAssetsForeignMetadata>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      minFeeAmounts: AugmentedQuery<
        ApiType,
        (
        ...
        [u32, ComposableTraitsXcmAssetsXcmAssetLocation]
      > &
        QueryableStorageEntry<
          ApiType,
          [u32, ComposableTraitsXcmAssetsXcmAssetLocation]
    ...
    assetTxPayment: {
       ...
       **/
      paymentAssets: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<ITuple<[u128, u128]>>>,
        [AccountId32]
      > &
    ...
    bondedFinance: {
       ...
       **/
      bondOfferCount: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * A mapping from offer ID to the pair: (issuer, offer)
       **/
      bondOffers: AugmentedQuery<
        ApiType,
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<
          Option<ITuple<[AccountId32, ComposableTraitsBondedFinanceBondOffer]>>
        >,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
    ...
    cosmwasm: {
       ...
       **/
      codeHashToId: AugmentedQuery<
        ApiType,
        (arg: H256 | string | Uint8Array) => Observable<Option<u64>>,
        [H256]
      > &
       ...
       **/
      codeIdToInfo: AugmentedQuery<
        ApiType,
        (
          arg: u64 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletCosmwasmCodeInfo>>,
        [u64]
      > &
       ...
       **/
      contractToInfo: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<PalletCosmwasmContractInfo>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
    ...
    crowdloanRewards: {
       ...
       **/
      associations: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<PalletCrowdloanRewardsModelsRemoteAccount>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      claimedRewards: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      rewards: AugmentedQuery<
        ...
        (
          arg:
            ...
            | string
            | Uint8Array
        ) => Observable<Option<PalletCrowdloanRewardsModelsReward>>,
        [PalletCrowdloanRewardsModelsRemoteAccount]
      > &
        QueryableStorageEntry<
          ApiType,
       ...
       **/
      vestingTimeStart: AugmentedQuery<
        ApiType,
    ...
    currencyFactory: {
      assetEd: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<u128>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      assetIdRanges: AugmentedQuery<
        ApiType,
        () => Observable<PalletCurrencyFactoryRanges>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      assetMetadata: AugmentedQuery<
        ApiType,
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<ComposableTraitsAssetsBasicAssetMetadata>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
    ...
    dexRouter: {
      dexRoutes: AugmentedQuery<
        ApiType,
        (
          arg1: u128 | AnyNumber | Uint8Array,
          arg2: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<ComposableTraitsDexDexRoute>>,
        [u128, u128]
      > &
    ...
    dutchAuction: {
       ...
       **/
      configurations: AugmentedQuery<
        ApiType,
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<ComposableTraitsTimeTimeReleaseFunction>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
       ...
       **/
      localOrderIdToRemote: AugmentedQuery<
        ApiType,
        (
          arg: u128 | AnyNumber | Uint8Array
      ...
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      ordersIndex: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * registered callback location for specific parachain
       **/
      parachainXcmCallbackLocation: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<ComposableTraitsXcmCumulusMethodId>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      sellOrders: AugmentedQuery<
        ApiType,
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletDutchAuctionSellOrder>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
       ...
       * HydraDX does)
       **/
      takes: AugmentedQuery<
        ApiType,
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<Vec<PalletDutchAuctionTakeOrder>>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      xcmSellOrders: AugmentedQuery<
        ApiType,
        (
          arg1: u32 | AnyNumber | Uint8Array,
    ...
    fnft: {
      collection: AugmentedQuery<
        ...
        (
          ...
          Option<ITuple<[AccountId32, AccountId32, BTreeMap<Bytes, Bytes>]>>
        >,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
       ...
       **/
      financialNftId: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<u64>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
       ...
       **/
      instance: AugmentedQuery<
        ApiType,
        (
          arg1: u128 | AnyNumber | Uint8Array,
          arg2: u64 | AnyNumber | Uint8Array
        ) => Observable<Option<ITuple<[AccountId32, BTreeMap<Bytes, Bytes>]>>>,
        [u128, u64]
      > &
       ...
       **/
      ownerInstances: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<BTreeSet<ITuple<[u128, u64]>>>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
    ...
    governanceRegistry: {
      originsByAssetId: AugmentedQuery<
        ApiType,
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<ComposableTraitsGovernanceSignedRawOrigin>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
    ...
    ibc: {
       ...
       **/
      acknowledgementCounter: AugmentedQuery<
        ApiType,
        () => Observable<u32>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      channelCounter: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
      ...
      channelsConnection: AugmentedQuery<
        ...
        ) => Observable<Vec<ITuple<[Bytes, Bytes]>>>,
        [Bytes]
      > &
       ...
       * counter for clients
       **/
      clientCounter: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       ...
       * counter for clients
       **/
      connectionCounter: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * height => IbcConsensusState
       **/
      hostConsensusStates: AugmentedQuery<
        ApiType,
        () => Observable<BTreeMap<u64, PalletIbcIbcConsensusState>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      packetCounter: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * counter for packet receipts
       **/
      packetReceiptCounter: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    lending: {
       ...
       **/
      accountCollateral: AugmentedQuery<
        ApiType,
        (
          arg1: u32 | AnyNumber | Uint8Array,
       ...
       **/
      borrowTimestamp: AugmentedQuery<
        ApiType,
        (
          arg1: u32 | AnyNumber | Uint8Array,
          arg2: AccountId32 | string | Uint8Array
       ...
       **/
      debtTokenForMarket: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<u128>>,
        [u32]
      > &
       ...
       **/
      lastBlockTimestamp: AugmentedQuery<ApiType, () => Observable<u64>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Lending instances counter
       **/
      lendingCount: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
      ...
      markets: AugmentedQuery<
        ...
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<ComposableTraitsLendingMarketConfig>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    liquidations: {
      defaultStrategyIndex: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      strategies: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<
          Option<PalletLiquidationsLiquidationStrategyConfiguration>
        >,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      strategyIndex: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    mosaic: {
      assetsInfo: AugmentedQuery<
        ApiType,
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletMosaicAssetInfo>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
       ...
       **/
      incomingTransactions: AugmentedQuery<
        ApiType,
        (
          arg1: AccountId32 | string | Uint8Array,
          arg2: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<ITuple<[u128, u32]>>>,
        [AccountId32, u128]
      > &
        QueryableStorageEntry<ApiType, [AccountId32, u128]>;
      localToRemoteAsset: AugmentedQuery<
        ApiType,
        (
          arg1: u128 | AnyNumber | Uint8Array,
          arg2: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<CommonMosaicRemoteAssetId>>,
        [u128, u32]
      > &
        QueryableStorageEntry<ApiType, [u128, u32]>;
      networkInfos: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletMosaicNetworkInfo>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      nonce: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Locked outgoing tx out of Picasso, that a relayer needs to process.
       **/
      outgoingTransactions: AugmentedQuery<
        ApiType,
        (
          arg1: AccountId32 | string | Uint8Array,
          arg2: u128 | AnyNumber | Uint8Array
      ...
      relayer: AugmentedQuery<
        ApiType,
        () => Observable<Option<PalletMosaicRelayerStaleRelayer>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      /**
      ...
      remoteToLocalAsset: AugmentedQuery<
        ...
        [CommonMosaicRemoteAssetId, u32]
      > &
        QueryableStorageEntry<ApiType, [CommonMosaicRemoteAssetId, u32]>;
      timeLockPeriod: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    oracle: {
       ...
       **/
      answerInTransit: AugmentedQuery<
        ApiType,
       ...
       **/
      assetsCount: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
      ...
      assetsInfo: AugmentedQuery<
        ...
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletOracleAssetInfo>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
       ...
       **/
      controllerToSigner: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<AccountId32>>,
       ...
       **/
      declaredWithdraws: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<PalletOracleWithdraw>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      prePrices: AugmentedQuery<
        ApiType,
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Vec<PalletOraclePrePrice>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
       ...
       **/
      priceHistory: AugmentedQuery<
        ApiType,
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Vec<ComposableTraitsOraclePrice>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
      ...
      prices: AugmentedQuery<
        ...
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<ComposableTraitsOraclePrice>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
       ...
       **/
      rewardTrackerStore: AugmentedQuery<
        ApiType,
        () => Observable<Option<ComposableTraitsOracleRewardTracker>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      /**
       ...
       **/
      signerToController: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<AccountId32>>,
    ...
    pablo: {
      ...
      pools: AugmentedQuery<
        ...
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletPabloPoolConfiguration>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      priceCumulativeState: AugmentedQuery<
        ApiType,
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletPabloPriceCumulative>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      twapState: AugmentedQuery<
        ApiType,
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletPabloTimeWeightedAveragePrice>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
    ...
    proxy: {
      ...
      announcements: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<ITuple<[Vec<PalletAccountProxyAnnouncement>, u128]>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
      ...
      proxies: AugmentedQuery<
        ...
        (
          ...
          ITuple<[Vec<ComposableTraitsAccountProxyProxyDefinition>, u128]>
        >,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
    ...
    session: {
      ...
      nextKeys: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array
        ) => Observable<Option<DaliRuntimeOpaqueSessionKeys>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
      ...
      queuedKeys: AugmentedQuery<
        ApiType,
        () => Observable<
          Vec<ITuple<[AccountId32, DaliRuntimeOpaqueSessionKeys]>>
        >,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
    ...
    stakingRewards: {
      rewardPools: AugmentedQuery<
        ...
        (
          arg: u128 | AnyNumber | Uint8Array
        ) => Observable<Option<ComposableTraitsStakingRewardPool>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      rewardsPotIsEmpty: AugmentedQuery<
        ApiType,
        (
          arg1: u128 | AnyNumber | Uint8Array,
          arg2: u128 | AnyNumber | Uint8Array
      ...
      > &
        QueryableStorageEntry<ApiType, [u128, u128]>;
      stakes: AugmentedQuery<
        ApiType,
        (
          arg1: u128 | AnyNumber | Uint8Array,
          arg2: u64 | AnyNumber | Uint8Array
        ) => Observable<Option<ComposableTraitsStakingStake>>,
        [u128, u64]
      > &
        QueryableStorageEntry<ApiType, [u128, u64]>;
      /**
    ...
    transfer: {
       ...
       **/
      channelIds: AugmentedQuery<ApiType, () => Observable<Vec<Bytes>>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Counter for the related counted storage map
       **/
      counterForIbcAssetIds: AugmentedQuery<
        ApiType,
        () => Observable<u32>,
        []
      > &
       ...
       **/
      ibcAssetIds: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<Bytes>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
       ...
       **/
      params: AugmentedQuery<
        ApiType,
        () => Observable<IbcTransferPalletParams>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      /**
    ...
    vault: {
       ...
       * the vault itself.
       **/
      capitalStructure: AugmentedQuery<
        ApiType,
        (
          arg1: u64 | AnyNumber | Uint8Array,
          arg2: AccountId32 | string | Uint8Array
        ) => Observable<PalletVaultModelsStrategyOverview>,
        [u64, AccountId32]
      > &
       ...
       **/
      lpTokensToVaults: AugmentedQuery<
        ApiType,
        (arg: u128 | AnyNumber | Uint8Array) => Observable<Option<u64>>,
        [u128]
      > &
        QueryableStorageEntry<ApiType, [u128]>;
      /**
       ...
       **/
      vaultCount: AugmentedQuery<ApiType, () => Observable<u64>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
      ...
      vaults: AugmentedQuery<
        ...
        (
          arg: u64 | AnyNumber | Uint8Array
        ) => Observable<Option<PalletVaultModelsVaultInfo>>,
        [u64]
      > &
        QueryableStorageEntry<ApiType, [u64]>;
      /**
    ...
    vesting: {
       ...
       **/
      vestingScheduleNonce: AugmentedQuery<
        ApiType,
        () => Observable<u128>,
        []
      > &
      ...
      vestingSchedules: AugmentedQuery<
        ...
        (
          arg1: AccountId32 | string | Uint8Array,
          arg2: u128 | AnyNumber | Uint8Array
        ) => Observable<BTreeMap<u128, ComposableTraitsVestingVestingSchedule>>,
        [AccountId32, u128]
      > &
        QueryableStorageEntry<ApiType, [AccountId32, u128]>;
      /**
