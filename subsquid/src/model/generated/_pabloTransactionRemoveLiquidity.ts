...
export class PabloTransactionRemoveLiquidity {
    public readonly isTypeOf = 'PabloTransactionRemoveLiquidity'
    private _id!: string
    private _event!: string
    private _pool!: string
    private _liquidityChanges!: (PabloLiquidityChange)[] | undefined | null

    constructor(props?: Partial<Omit<PabloTransactionRemoveLiquidity, 'toJSON'>>, json?: any) {
