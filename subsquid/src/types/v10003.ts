...
export type VestingScheduleIdSet =
  | VestingScheduleIdSet_All
  | VestingScheduleIdSet_One
  | VestingScheduleIdSet_Many;
...
export type VestingWindow =
  | VestingWindow_MomentBased
  | VestingWindow_BlockNumberBased;
