...
nix flake show --allow-import-from-derivation --show-trace --override-input flake-utils ./.nix/override-input/flake-utils/   --show-trace --fallback
...
nix flake check --override-input flake-utils ./.nix/override-input/flake-utils/ --no-update-lock-file --keep-going --fallback
