    ...
    in
    {
      ...
      apps = {
        simnode-tests-composable =
          self.inputs.flake-utils.lib.mkApp { drv = run-simnode-tests "composable"; };
        simnode-tests-picasso =
          self.inputs.flake-utils.lib.mkApp { drv = run-simnode-tests "picasso"; };
        simnode-tests-dali-rococo =
          self.inputs.flake-utils.lib.mkApp { drv = run-simnode-tests "dali-rococo"; };
