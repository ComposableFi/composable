...
import type {
  ...
  DaliRuntimeOpaqueSessionKeys, FrameSupportDispatchPerDispatchClassWeight,
  ...
  PalletOracleWithdraw, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletSchedulerScheduled,
  ...
  SpRuntimeDigest,
  SpTrieStorageProof, SpWeightsWeightV2Weight,
  XcmV1MultiLocation,
