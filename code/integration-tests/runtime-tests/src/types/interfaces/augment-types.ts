...
import type { ComposableTraitsDexFee, ComposableTraitsDexStakingRewardPool, PalletPabloPoolConfiguration, PalletPabloPoolId, PalletPabloPoolInitConfiguration, PalletPabloPriceAggregate, PalletPabloPriceCumulative, PalletPabloTimeWeightedAveragePrice, RemoveLiquiditySimulationResult } from '@composable/types/interfaces/pablo';
...
declare module '@polkadot/types/types/registry' {
  interface InterfaceTypes {
    ...
    Releases: Releases;
    Remark: Remark;
    RemoveLiquiditySimulationResult: RemoveLiquiditySimulationResult;
