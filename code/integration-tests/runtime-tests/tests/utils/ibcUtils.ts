...
export async function getStateOfFundsForPicassoToComposable(composableApi: ApiPromise, picassoApi: ApiPromise, wallet: KeyringPair) {
  ...
  const preBalancesOnComposable = await queryAllBalanceOnComposable(composableApi, [picaIdOnComposable, ksmOnComposable, dotOncomposable, usdtOnComposable], wallet.address);
