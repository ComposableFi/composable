...
export class CwXcCoreQueryClient implements CwXcCoreReadOnlyInterface {
...
export interface CwXcCoreInterface extends CwXcCoreReadOnlyInterface {
  contractAddress: string;
  sender: string;
...
export class CwXcCoreClient extends CwXcCoreQueryClient implements CwXcCoreInterface {
