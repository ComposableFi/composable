...
library IbcLightclientsMockV1ClientState {
     ...
     * @return The number of bytes decoded
     */
    function _read_latest_height(uint256 p, bytes memory bs, Data memory r) internal pure returns (uint) {
     ...
     */
    function _decode_Height(uint256 p, bytes memory bs) internal pure returns (Height.Data memory, uint) {
        uint256 pointer = p;
...
library IbcLightclientsMockV1ConsensusState {
     ...
     * @return The number of bytes decoded
     */
    function _read_timestamp(uint256 p, bytes memory bs, Data memory r) internal pure returns (uint) {
...
library IbcLightclientsMockV1Header {
     ...
     * @return The number of bytes decoded
     */
    function _read_height(uint256 p, bytes memory bs, Data memory r) internal pure returns (uint) {
        (Height.Data memory x, uint256 sz) = _decode_Height(p, bs);
        r.height = x;
        return sz;
    }
