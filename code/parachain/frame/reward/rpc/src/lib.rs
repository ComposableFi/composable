...
impl<C, Block, AccountId, CurrencyId, Balance, BlockNumber, UnsignedFixedPoint>
    RewardApiServer<<Block as BlockT>::Hash, AccountId, CurrencyId, Balance, BlockNumber, UnsignedFixedPoint>
    for Reward<C, Block>
where
    Block: BlockT,
    C: Send + Sync + 'static + ProvideRuntimeApi<Block> + HeaderBackend<Block>,
    C::Api: RewardRuntimeApi<Block, AccountId,  CurrencyId, Balance, BlockNumber, UnsignedFixedPoint>,
    AccountId: Codec,
    CurrencyId: Codec,
    Balance: Codec + MaybeDisplay + MaybeFromStr,
    BlockNumber: Codec,
