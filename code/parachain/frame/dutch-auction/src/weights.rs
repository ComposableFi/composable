...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn ask() -> Weight {
		Weight::from_ref_time(36_854_000 as u64)
	...
	fn take() -> Weight {
		Weight::from_ref_time(21_406_000 as u64)
			.saturating_add(T::DbWeight::get().reads(4 as u64))
	...
	// Storage: System Account (r:1 w:1)
	fn liquidate() -> Weight {
		Weight::from_ref_time(33_038_000 as u64)
	...
	// Storage: DutchAuction SellOrders (r:0 w:1)
	fn xcm_sell() -> Weight {
		Weight::from_ref_time(44_295_000 as u64)
