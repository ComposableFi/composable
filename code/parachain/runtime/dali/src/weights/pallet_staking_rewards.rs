...
impl<T: frame_system::Config> pallet_staking_rewards::WeightInfo for WeightInfo<T> {
	...
	fn extend(r: u32, ) -> Weight {
		(216_264_000 as Weight)
			// Standard Error: 250_000
			.saturating_add((3_401_000 as Weight).saturating_mul(r as Weight))
	...
	fn unstake(r: u32, ) -> Weight {
		(309_876_000 as Weight)
			// Standard Error: 268_000
			.saturating_add((13_314_000 as Weight).saturating_mul(r as Weight))
