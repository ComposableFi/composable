...
impl<T: frame_system::Config> indices::WeightInfo for WeightInfo<T> {
	...
	fn claim() -> Weight {
		...
		Weight::from_ref_time(50_424_000)
	...
	fn transfer() -> Weight {
		// Minimum execution time: 57_926 nanoseconds.
		Weight::from_ref_time(58_808_000)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	// Storage: Indices Accounts (r:1 w:1)
	fn free() -> Weight {
		// Minimum execution time: 49_056 nanoseconds.
		Weight::from_ref_time(50_994_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	// Storage: Indices Accounts (r:1 w:1)
	...
	fn force_transfer() -> Weight {
		// Minimum execution time: 51_581 nanoseconds.
		Weight::from_ref_time(52_519_000)
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	// Storage: Indices Accounts (r:1 w:1)
	fn freeze() -> Weight {
		// Minimum execution time: 56_411 nanoseconds.
		Weight::from_ref_time(58_345_000)
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
