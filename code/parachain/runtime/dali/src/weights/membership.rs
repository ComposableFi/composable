...
impl<T: frame_system::Config> membership::WeightInfo for WeightInfo<T> {
	...
	fn add_member(m: u32, ) -> Weight {
		Weight::from_ref_time(41_331_000_u64)
	...
	fn remove_member(m: u32, ) -> Weight {
		Weight::from_ref_time(47_040_000_u64)
	...
	fn swap_member(m: u32, ) -> Weight {
		Weight::from_ref_time(47_699_000_u64)
			// Standard Error: 7_000
			.saturating_add(Weight::from_ref_time(212_000_u64).saturating_mul(m as u64))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	// Storage: CouncilMembership Members (r:1 w:1)
	...
	fn reset_member(m: u32, ) -> Weight {
		Weight::from_ref_time(47_567_000_u64)
			// Standard Error: 8_000
			.saturating_add(Weight::from_ref_time(436_000_u64).saturating_mul(m as u64))
			.saturating_add(T::DbWeight::get().reads(3_u64))
			.saturating_add(T::DbWeight::get().writes(3_u64))
	}
	// Storage: CouncilMembership Members (r:1 w:1)
	...
	fn change_key(m: u32, ) -> Weight {
		Weight::from_ref_time(51_033_000_u64)
			// Standard Error: 8_000
			.saturating_add(Weight::from_ref_time(198_000_u64).saturating_mul(m as u64))
			.saturating_add(T::DbWeight::get().reads(3_u64))
	...
	fn set_prime(m: u32, ) -> Weight {
		Weight::from_ref_time(13_061_000_u64)
			// Standard Error: 2_000
			.saturating_add(Weight::from_ref_time(93_000_u64).saturating_mul(m as u64))
	...
	fn clear_prime(m: u32, ) -> Weight {
		Weight::from_ref_time(4_966_000_u64)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(5_000_u64).saturating_mul(m as u64))
			.saturating_add(T::DbWeight::get().writes(2_u64))
	}
}
