...
impl<T: frame_system::Config> liquidations::WeightInfo for WeightInfo<T> {
	...
	fn add_liquidation_strategy() -> Weight {
		...
		Weight::from_ref_time(15_558_000 as u64)
	...
	fn sell(x: u32, ) -> Weight {
		// Minimum execution time: 111_912 nanoseconds.
		Weight::from_ref_time(114_252_309 as u64)
			// Standard Error: 51_234
			.saturating_add(Weight::from_ref_time(1_679_898 as u64).saturating_mul(x as u64))
