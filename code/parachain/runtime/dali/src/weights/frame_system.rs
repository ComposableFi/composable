...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn set_heap_pages() -> Weight {
		Weight::from_ref_time(19_355_000_u64)
	...
	fn set_storage(i: u32, ) -> Weight {
		Weight::from_ref_time(0_u64)
			...
			.saturating_add(Weight::from_ref_time(1_554_000_u64).saturating_mul(i as u64))
	...
	fn kill_storage(i: u32, ) -> Weight {
		Weight::from_ref_time(0_u64)
			// Standard Error: 6_000
			.saturating_add(Weight::from_ref_time(1_228_000_u64).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i as u64)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	/// The range of component `p` is `[1, 1000]`.
	fn kill_prefix(p: u32, ) -> Weight {
		Weight::from_ref_time(11_074_000_u64)
			// Standard Error: 6_000
			.saturating_add(Weight::from_ref_time(2_118_000_u64).saturating_mul(p as u64))
