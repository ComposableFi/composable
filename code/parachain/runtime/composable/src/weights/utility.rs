...
impl<T: frame_system::Config> utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		Weight::from_ref_time(34_796_000_u64)
			// Standard Error: 5_000
			.saturating_add(Weight::from_ref_time(8_531_000_u64).saturating_mul(c as u64))
	}
	fn as_derivative() -> Weight {
		Weight::from_ref_time(15_550_000_u64)
	}
	/// The range of component `c` is `[0, 1000]`.
	fn batch_all(c: u32, ) -> Weight {
		Weight::from_ref_time(45_171_000_u64)
			// Standard Error: 3_000
			.saturating_add(Weight::from_ref_time(8_913_000_u64).saturating_mul(c as u64))
	}
	fn dispatch_as() -> Weight {
		Weight::from_ref_time(32_513_000_u64)
	}
	/// The range of component `c` is `[0, 1000]`.
	fn force_batch(c: u32, ) -> Weight {
		Weight::from_ref_time(42_000_000_u64)
			// Standard Error: 5_000
			.saturating_add(Weight::from_ref_time(8_526_000_u64).saturating_mul(c as u64))
	}
}
