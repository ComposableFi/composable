...
impl<T: frame_system::Config> utility::WeightInfo for WeightInfo<T> {
	...
	fn batch(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(30_563_389)
			.saturating_add(Weight::from_proof_size(2687))
			// Standard Error: 6_823
			.saturating_add(Weight::from_ref_time(12_359_504).saturating_mul(c.into()))
	...
	fn as_derivative() -> Weight {
		...
		Weight::from_ref_time(17_026_000)
			.saturating_add(Weight::from_proof_size(2687))
			.saturating_add(T::DbWeight::get().reads(1))
	}
	/// Storage: CallFilter DisabledCalls (r:1 w:0)
	...
	fn batch_all(c: u32, ) -> Weight {
		...
		Weight::from_ref_time(19_322_215)
			.saturating_add(Weight::from_proof_size(2687))
			// Standard Error: 7_263
			.saturating_add(Weight::from_ref_time(12_813_615).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1))
	}
	...
	fn force_batch(c: u32, ) -> Weight {
		...
		//  Measured:  `76`
		//  Estimated: `2687`
		// Minimum execution time: 12_407 nanoseconds.
		Weight::from_ref_time(18_502_341)
			.saturating_add(Weight::from_proof_size(2687))
			// Standard Error: 10_120
			.saturating_add(Weight::from_ref_time(12_263_830).saturating_mul(c.into()))
			.saturating_add(T::DbWeight::get().reads(1))
	}
}
