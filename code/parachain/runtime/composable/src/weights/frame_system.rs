...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		Weight::from_ref_time(4_067_000_u64)
			// Standard Error: 0
	...
	fn set_heap_pages() -> Weight {
		Weight::from_ref_time(15_638_000_u64)
	...
	fn set_storage(i: u32, ) -> Weight {
		Weight::from_ref_time(0_u64)
			...
			.saturating_add(Weight::from_ref_time(1_527_000_u64).saturating_mul(i as u64))
	...
	fn kill_storage(i: u32, ) -> Weight {
		Weight::from_ref_time(0_u64)
			...
			.saturating_add(Weight::from_ref_time(1_211_000_u64).saturating_mul(i as u64))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i as u64)))
	}
	// Storage: Skipped Metadata (r:0 w:0)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		Weight::from_ref_time(0_u64)
			...
			.saturating_add(Weight::from_ref_time(2_178_000_u64).saturating_mul(p as u64))
