...
impl<T: frame_system::Config> frame_system::WeightInfo for WeightInfo<T> {
	...
	fn remark(b: u32, ) -> Weight {
		...
		//  Measured:  `0`
		//  Estimated: `0`
		// Minimum execution time: 3_585 nanoseconds.
		Weight::from_ref_time(3_628_000)
			// Standard Error: 0
			.saturating_add(Weight::from_ref_time(455).saturating_mul(b.into()))
	}
	/// The range of component `b` is `[0, 3932160]`.
	fn remark_with_event(b: u32, ) -> Weight {
		...
		Weight::from_ref_time(12_237_000)
			// Standard Error: 2
			.saturating_add(Weight::from_ref_time(2_095).saturating_mul(b.into()))
	}
	...
	fn set_heap_pages() -> Weight {
		...
		Weight::from_parts(7_245_000, 495)
	...
	fn set_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(3_620_000)
			...
			.saturating_add(Weight::from_ref_time(1_086_358).saturating_mul(i.into()))
	...
	fn kill_storage(i: u32, ) -> Weight {
		...
		Weight::from_ref_time(3_627_000)
			...
			.saturating_add(Weight::from_ref_time(779_068).saturating_mul(i.into()))
			.saturating_add(T::DbWeight::get().writes((1_u64).saturating_mul(i.into())))
	}
	/// Storage: Skipped Metadata (r:0 w:0)
	/// Proof Skipped: Skipped Metadata (max_values: None, max_size: None, mode: Measured)
	...
	fn kill_prefix(p: u32, ) -> Weight {
		...
		//  Measured:  `97 + p * (69 ±0)`
		//  Estimated: `97 + p * (70 ±0)`
		// Minimum execution time: 6_599 nanoseconds.
		Weight::from_parts(6_637_000, 97)
			// Standard Error: 2_146
			.saturating_add(Weight::from_ref_time(1_340_788).saturating_mul(p.into()))
