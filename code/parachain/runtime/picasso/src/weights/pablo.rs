...
impl<T: frame_system::Config> pablo::WeightInfo for WeightInfo<T> {
	...
	fn create() -> Weight {
		// Minimum execution time: 48_047 nanoseconds.
	...
	fn add_liquidity() -> Weight {
		// Minimum execution time: 248_244 nanoseconds.
		Weight::from_ref_time(254_775_000 as u64)
	...
	fn remove_liquidity() -> Weight {
		// Minimum execution time: 155_673 nanoseconds.
		Weight::from_ref_time(157_961_000 as u64)
			.saturating_add(T::DbWeight::get().reads(9 as u64))
	...
	// Storage: Pablo PriceCumulativeState (r:1 w:1)
	fn buy() -> Weight {
		// Minimum execution time: 135_263 nanoseconds.
		Weight::from_ref_time(138_627_000 as u64)
	...
	// Storage: Pablo PriceCumulativeState (r:1 w:1)
	fn swap() -> Weight {
		// Minimum execution time: 136_721 nanoseconds.
		Weight::from_ref_time(140_670_000 as u64)
			.saturating_add(T::DbWeight::get().reads(8 as u64))
			.saturating_add(T::DbWeight::get().writes(6 as u64))
	}
	// Storage: CurrencyFactory AssetIdRanges (r:1 w:1)
	...
	fn do_create_pool() -> Weight {
		...
		Weight::from_ref_time(44_448_000 as u64)
			.saturating_add(T::DbWeight::get().reads(2 as u64))
			.saturating_add(T::DbWeight::get().writes(3 as u64))
	}
}
