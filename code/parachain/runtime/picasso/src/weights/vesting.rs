...
impl<T: frame_system::Config> vesting::WeightInfo for WeightInfo<T> {
	...
	fn claim(s: u32, ) -> Weight {
		(94_177_000 as Weight)
			// Standard Error: 11_000
			.saturating_add((4_545_000 as Weight).saturating_mul(s as Weight))
	...
	fn claim_for(s: u32, ) -> Weight {
		(90_466_000 as Weight)
			// Standard Error: 5_000
			.saturating_add((4_333_000 as Weight).saturating_mul(s as Weight))
			.saturating_add(T::DbWeight::get().reads(4 as Weight))
			.saturating_add(T::DbWeight::get().writes(3 as Weight))
	}
}
