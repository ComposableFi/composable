          ...
          packages = rec {
            ...
            kusama-picasso-karura =
              let      
                ...
                config = pkgs.callPackage ./scripts/polkadot-launch/networks.nix 
                { 
                  kusama-bin = "/foo";  #polkadot-node; 
                  picasso-bin = "/bar"; # composable-node;   
                };              
                config-file = writeTextFile {
                  name = "kusama-local-picasso-dev-karura-dev.json";
                  text = "${builtins.toJSON config.kusama-local-picasso-dev-karura-dev}";
                };
              in
              writeShellApplication {
