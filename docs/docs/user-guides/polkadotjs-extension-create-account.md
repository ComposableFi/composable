...
![add_account](images-create-account-polkadotjs/add-account.png)
...
![extension_windowed](images-create-account-polkadotjs/extension-windowed.png)
...
![create_new_account](images-create-account-polkadotjs/create-new-account.png)
...
![mnemonic_seed](images-create-account-polkadotjs/mnemonic-seed-polkadotjs.png)
...
![account_credentials](images-create-account-polkadotjs/account-credentials.png)
...
![picasso_access_request](images-create-account-polkadotjs/polkadotjs-picasso-access-request.png)

1. Click "Yes, allow this application access"

![choose_your_wallet](images-create-account-polkadotjs/polkadotjs-choose-your-wallet.png)
